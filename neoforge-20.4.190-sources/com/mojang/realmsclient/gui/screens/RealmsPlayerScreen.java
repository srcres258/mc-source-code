...
public class RealmsPlayerScreen extends RealmsScreen {
    ...
    public void init() {
        ...
        this.removeButton = this.addRenderableWidget(
            Button.builder(Component.translatable("mco.configure.world.invites.remove.tooltip"), p_278866_ -> this.uninvite(this.playerIndex))
        ...
        this.addRenderableWidget(
            Button.builder(CommonComponents.GUI_BACK, p_89122_ -> this.backButtonClicked())
    ...
    class Entry extends ObjectSelectionList.Entry<RealmsPlayerScreen.Entry> {
        ...
        public Entry(PlayerInfo pPlayerInfo) {
            ...
            this.removeButton = new ImageButton(j, k, 8, 7, REMOVE_BUTTON_SPRITES, p_279099_ -> RealmsPlayerScreen.this.uninvite(i), CommonComponents.EMPTY);
            this.removeButton.setTooltip(Tooltip.create(RealmsPlayerScreen.REMOVE_ENTRY_TOOLTIP));
            this.children.add(this.removeButton);
            j += 11;
            this.makeOpButton = new ImageButton(j, k, 8, 7, MAKE_OP_BUTTON_SPRITES, p_279435_ -> RealmsPlayerScreen.this.op(i), CommonComponents.EMPTY);
            this.makeOpButton.setTooltip(Tooltip.create(RealmsPlayerScreen.NORMAL_USER_TOOLTIP));
            this.children.add(this.makeOpButton);
            this.removeOpButton = new ImageButton(j, k, 8, 7, REMOVE_OP_BUTTON_SPRITES, p_279383_ -> RealmsPlayerScreen.this.deop(i), CommonComponents.EMPTY);
