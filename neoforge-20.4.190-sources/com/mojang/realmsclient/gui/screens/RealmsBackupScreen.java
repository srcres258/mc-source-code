...
public class RealmsBackupScreen extends RealmsScreen {
    ...
    public void init() {
        ...
        this.downloadButton = this.addRenderableWidget(
            Button.builder(Component.translatable("mco.backup.button.download"), p_88185_ -> this.downloadClicked())
                .bounds(this.width - 135, row(1), 120, 20)
                .build()
        );
        this.restoreButton = this.addRenderableWidget(
            Button.builder(Component.translatable("mco.backup.button.restore"), p_88179_ -> this.restoreClicked(this.selectedBackup))
        ...
        this.addRenderableWidget(
            Button.builder(CommonComponents.GUI_BACK, p_280691_ -> this.minecraft.setScreen(this.lastScreen))
    ...
    private void restore() {
        ...
        this.selectedBackup = -1;
        this.minecraft
            .setScreen(new RealmsLongRunningMcoTaskScreen(this.lastScreen.getNewScreen(), new RestoreTask(backup, this.serverData.id, this.lastScreen)));
    }
    ...
    public void render(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        if (this.noBackups) {
            pGuiGraphics.drawString(this.font, NO_BACKUPS_LABEL, 20, this.height / 2 - 10, -1, false);
        }
    ...
    class Entry extends ObjectSelectionList.Entry<RealmsBackupScreen.Entry> {
        ...
        private void addChangesButton() {
            ...
            this.changesButton = new ImageButton(
                ...
                p_279278_ -> RealmsBackupScreen.this.minecraft.setScreen(new RealmsBackupInfoScreen(RealmsBackupScreen.this, this.backup)),
        ...
        private void addRestoreButton() {
            ...
            this.restoreButton = new ImageButton(
                ...
                p_279191_ -> RealmsBackupScreen.this.restoreClicked(RealmsBackupScreen.this.backups.indexOf(this.backup)),
                CommonComponents.EMPTY
            );
        ...
        public void render(
            ...
            pGuiGraphics.drawString(
                RealmsBackupScreen.this.font, this.getMediumDatePresentation(this.backup.lastModifiedDate), pLeft, pTop + 12, 5000268, false
            );
