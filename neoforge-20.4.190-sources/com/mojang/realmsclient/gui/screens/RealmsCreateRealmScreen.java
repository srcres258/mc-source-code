...
public class RealmsCreateRealmScreen extends RealmsScreen {
    ...
    public RealmsCreateRealmScreen(RealmsMainScreen pLastScreen, RealmsServer pRealmsServer) {
        super(CREATE_REALM_TEXT);
        this.lastScreen = pLastScreen;
        this.createWorldRunnable = () -> this.createWorld(pRealmsServer);
    }

    public RealmsCreateRealmScreen(RealmsMainScreen pLastScreen, long pParentId) {
        super(CREATE_REALM_TEXT);
        this.lastScreen = pLastScreen;
        this.createWorldRunnable = () -> this.createSnapshotWorld(pParentId);
    }
    ...
    public void init() {
        ...
        this.nameBox.setResponder(p_293568_ -> button.active = !Util.isBlank(p_293568_));
    ...
    private void createWorld(RealmsServer pRealmsServer) {
        WorldCreationTask worldcreationtask = new WorldCreationTask(pRealmsServer.id, this.nameBox.getValue(), this.descriptionBox.getValue());
        RealmsResetWorldScreen realmsresetworldscreen = RealmsResetWorldScreen.forNewRealm(
            this, pRealmsServer, worldcreationtask, () -> this.minecraft.execute(() -> {
    ...
    private void createSnapshotWorld(long pParentId) {
                    ...
                    this.minecraft
                        .setScreen(
                            new RealmsLongRunningMcoTaskScreen(
                                this,
                                new CreateSnapshotRealmTask(this.lastScreen, pParentId, p_305627_, this.nameBox.getValue(), this.descriptionBox.getValue())
                            )
                        );
                }
            },
