...
public class Library {
     ...
     *
     * @param pDeviceSpecifier A string specifying the name of the audio device to use
     *                         , or null to use the default device.
     * @param pEnableHrtf      Whether to enable HRTF (head-related transfer function)
     *                         for spatial audio.
     */
     ...
     *
     * @param pDeviceSpecifier The name of the audio device to open, or null to open
     *                         the default device.
     */
     ...
     *
     * @param pDeviceSpecifier A string specifying the name of the audio device to
     *                         open, or null to use the default device.
     */
