...
public class ClientboundMapItemDataPacket implements Packet<ClientGamePacketListener> {
    ...
    public ClientboundMapItemDataPacket(
        int pMapId, byte pScale, boolean pLocked, @Nullable Collection<MapDecoration> pDecorations, @Nullable MapItemSavedData.MapPatch pColorPatch
    ) {
        this.mapId = pMapId;
        this.scale = pScale;
        this.locked = pLocked;
    ...
    public ClientboundMapItemDataPacket(FriendlyByteBuf pBuffer) {
        ...
        this.decorations = pBuffer.readNullable(p_237731_ -> p_237731_.readList(p_178981_ -> {
    ...
    public void write(FriendlyByteBuf pBuffer) {
        ...
        pBuffer.writeNullable(this.decorations, (p_237728_, p_237729_) -> p_237728_.writeCollection(p_237729_, (p_297948_, p_297949_) -> {
                p_297948_.writeEnum(p_297949_.type());
                p_297948_.writeByte(p_297949_.x());
                p_297948_.writeByte(p_297949_.y());
                p_297948_.writeByte(p_297949_.rot() & 15);
                p_297948_.writeNullable(p_297949_.name(), FriendlyByteBuf::writeComponent);
            }));
