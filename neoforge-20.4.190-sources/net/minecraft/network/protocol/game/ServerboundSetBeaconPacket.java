...
public class ServerboundSetBeaconPacket implements Packet<ServerGamePacketListener> {
    ...
    public ServerboundSetBeaconPacket(FriendlyByteBuf pBuffer) {
        this.primary = pBuffer.readOptional(p_258214_ -> p_258214_.readById(BuiltInRegistries.MOB_EFFECT));
        this.secondary = pBuffer.readOptional(p_258215_ -> p_258215_.readById(BuiltInRegistries.MOB_EFFECT));
    }
    ...
    public void write(FriendlyByteBuf pBuffer) {
        pBuffer.writeOptional(this.primary, (p_258216_, p_258217_) -> p_258216_.writeId(BuiltInRegistries.MOB_EFFECT, p_258217_));
        pBuffer.writeOptional(this.secondary, (p_258218_, p_258219_) -> p_258218_.writeId(BuiltInRegistries.MOB_EFFECT, p_258219_));
    }
