...
public class ClientboundLightUpdatePacketData {
    ...
    public ClientboundLightUpdatePacketData(FriendlyByteBuf pBuffer, int pX, int pZ) {
        ...
        this.skyUpdates = pBuffer.readList(p_195756_ -> p_195756_.readByteArray(2048));
        this.blockUpdates = pBuffer.readList(p_195753_ -> p_195753_.readByteArray(2048));
    }
    ...
    private void prepareSectionData(
        ChunkPos pChunkPos, LevelLightEngine pLevelLightEngine, LightLayer pLightLayer, int p_195745_, BitSet pSkyLight, BitSet pBlockLight, List<byte[]> pUpdates
    ) {
