...
public class ServerboundEditBookPacket implements Packet<ServerGamePacketListener> {
    ...
    public ServerboundEditBookPacket(FriendlyByteBuf pBuffer) {
        ...
        this.pages = pBuffer.readCollection(FriendlyByteBuf.limitValue(Lists::newArrayListWithCapacity, 200), p_182763_ -> p_182763_.readUtf(8192));
        this.title = pBuffer.readOptional(p_182757_ -> p_182757_.readUtf(128));
    }
    ...
    public void write(FriendlyByteBuf pBuffer) {
        ...
        pBuffer.writeCollection(this.pages, (p_182759_, p_182760_) -> p_182759_.writeUtf(p_182760_, 8192));
        pBuffer.writeOptional(this.title, (p_182753_, p_182754_) -> p_182753_.writeUtf(p_182754_, 128));
    }
