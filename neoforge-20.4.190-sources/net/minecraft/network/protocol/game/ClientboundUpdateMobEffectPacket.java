...
public class ClientboundUpdateMobEffectPacket implements Packet<ClientGamePacketListener> {
    ...
    public ClientboundUpdateMobEffectPacket(int pEntityId, MobEffectInstance pEffectInstance) {
        ...
        this.flags = b0;
        this.factorData = pEffectInstance.getFactorData().orElse(null);
    }
    ...
    public ClientboundUpdateMobEffectPacket(FriendlyByteBuf pBuffer) {
        ...
        this.factorData = pBuffer.readNullable(p_293742_ -> p_293742_.readWithCodecTrusted(NbtOps.INSTANCE, MobEffectInstance.FactorData.CODEC));
    }
    ...
    public void write(FriendlyByteBuf pBuffer) {
        ...
        pBuffer.writeNullable(
            this.factorData, (p_293740_, p_293741_) -> p_293740_.writeWithCodec(NbtOps.INSTANCE, MobEffectInstance.FactorData.CODEC, p_293741_)
        );
    }
