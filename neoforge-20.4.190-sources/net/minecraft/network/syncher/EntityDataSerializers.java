...
public class EntityDataSerializers {
    ...
    public static final EntityDataSerializer<Byte> BYTE = EntityDataSerializer.simple(
        (p_293746_, p_293747_) -> p_293746_.writeByte(p_293747_), FriendlyByteBuf::readByte
    );
    ...
    public static final EntityDataSerializer<VillagerData> VILLAGER_DATA = new EntityDataSerializer.ForValueType<VillagerData>() {
        ...
        public VillagerData read(FriendlyByteBuf p_238156_) {
            return new VillagerData(
                p_238156_.readById(BuiltInRegistries.VILLAGER_TYPE), p_238156_.readById(BuiltInRegistries.VILLAGER_PROFESSION), p_238156_.readVarInt()
            );
        }
    };
    ...
    public static void registerSerializer(EntityDataSerializer<?> pSerializer) {
        ...
        if (SERIALIZERS.add(pSerializer) >= net.neoforged.neoforge.common.CommonHooks.VANILLA_SERIALIZER_LIMIT)
    ...
    public static EntityDataSerializer<?> getSerializer(int pId) {
        return net.neoforged.neoforge.common.CommonHooks.getSerializer(pId, SERIALIZERS);
    }

    public static int getSerializedId(EntityDataSerializer<?> pSerializer) {
        return net.neoforged.neoforge.common.CommonHooks.getSerializerId(pSerializer, SERIALIZERS);
    }
