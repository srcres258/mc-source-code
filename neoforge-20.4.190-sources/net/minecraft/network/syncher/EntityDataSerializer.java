...
public interface EntityDataSerializer<T> {
    ...
    static <T extends Enum<T>> EntityDataSerializer<T> simpleEnum(Class<T> pEnumType) {
        return simple(FriendlyByteBuf::writeEnum, p_238094_ -> p_238094_.readEnum(pEnumType));
    }

    static <T> EntityDataSerializer<T> simpleId(IdMap<T> pMap) {
        return simple((p_238088_, p_238089_) -> p_238088_.writeId(pMap, (T)p_238089_), p_238085_ -> p_238085_.<T>readById(pMap));
    }
