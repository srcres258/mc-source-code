...
public class ItemModelGenerators {
    ...
    private JsonObject generateBaseArmorTrimTemplate(ResourceLocation pModelLocation, Map<TextureSlot, ResourceLocation> pModelGetter, ArmorMaterial pArmorMaterial) {
        ...
        if (pArmorItem.getMaterial() == ArmorMaterials.LEATHER) {
            ModelTemplates.TWO_LAYERED_ITEM
                .create(
                    ...
                    this.output,
                    (p_267902_, p_267903_) -> this.generateBaseArmorTrimTemplate(p_267902_, p_267903_, pArmorItem.getMaterial())
                );
        } else {
            ModelTemplates.FLAT_ITEM
                .create(
                    ...
                    this.output,
                    (p_267905_, p_267906_) -> this.generateBaseArmorTrimTemplate(p_267905_, p_267906_, pArmorItem.getMaterial())
                );
        }
