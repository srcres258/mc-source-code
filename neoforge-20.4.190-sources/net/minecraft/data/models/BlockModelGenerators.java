...
public class BlockModelGenerators {
    ...
    public BlockModelGenerators(
        Consumer<BlockStateGenerator> pBlockStateOutput, BiConsumer<ResourceLocation, Supplier<JsonElement>> pModelOutput, Consumer<Item> pSkippedAutoModelsOutput
    ) {
    ...
    private void createSimpleFlatItemModel(Block pFlatBlock, String pLayerZeroTextureSuffix) {
        ...
        ModelTemplates.FLAT_ITEM
            .create(ModelLocationUtils.getModelLocation(item), TextureMapping.layer0(TextureMapping.getBlockTexture(pFlatBlock, pLayerZeroTextureSuffix)), this.modelOutput);
    }
    ...
    private static MultiVariantGenerator createRotatedVariant(Block pBlock, ResourceLocation pNormalModelLocation, ResourceLocation pMirroredModelLocation) {
        return MultiVariantGenerator.multiVariant(
            pBlock,
            Variant.variant().with(VariantProperties.MODEL, pNormalModelLocation),
            Variant.variant().with(VariantProperties.MODEL, pMirroredModelLocation),
            Variant.variant().with(VariantProperties.MODEL, pNormalModelLocation).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180),
            Variant.variant().with(VariantProperties.MODEL, pMirroredModelLocation).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)
        );
    }
    ...
    static BlockStateGenerator createWall(Block pWallBlock, ResourceLocation pPostModelLocation, ResourceLocation pLowSideModelLocation, ResourceLocation pTallSideModelLocation) {
        return MultiPartGenerator.multiPart(pWallBlock)
            .with(Condition.condition().term(BlockStateProperties.UP, true), Variant.variant().with(VariantProperties.MODEL, pPostModelLocation))
            .with(
    ...
    private static BlockStateGenerator createOrientableTrapdoor(
        Block pOrientableTrapdoorBlock, ResourceLocation pTopModelLocation, ResourceLocation pBottomModelLocation, ResourceLocation pOpenModelLocation
    ) {
            ...
            .with(
                PropertyDispatch.properties(BlockStateProperties.HORIZONTAL_FACING, BlockStateProperties.HALF, BlockStateProperties.OPEN)
                    ...
                    .select(
                        ...
                        Half.BOTTOM,
                        false,
                        Variant.variant().with(VariantProperties.MODEL, pBottomModelLocation).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)
                    )
                    .select(
                        Direction.EAST,
                        Half.BOTTOM,
                        false,
                        Variant.variant().with(VariantProperties.MODEL, pBottomModelLocation).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)
                    )
                    .select(
                        Direction.WEST,
                        Half.BOTTOM,
                        false,
                        Variant.variant().with(VariantProperties.MODEL, pBottomModelLocation).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270)
                    )
                    ...
                    .select(
                        ...
                        Half.TOP,
                        false,
                        Variant.variant().with(VariantProperties.MODEL, pTopModelLocation).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)
                    )
                    .select(
                        Direction.EAST,
                        Half.TOP,
                        false,
                        Variant.variant().with(VariantProperties.MODEL, pTopModelLocation).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)
                    )
                    .select(
                        Direction.WEST,
                        Half.TOP,
                        false,
                        Variant.variant().with(VariantProperties.MODEL, pTopModelLocation).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270)
                    )
                    ...
                    .select(
                        ...
                        Half.BOTTOM,
                        true,
                        Variant.variant().with(VariantProperties.MODEL, pOpenModelLocation).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)
                    )
                    .select(
                        Direction.EAST,
                        Half.BOTTOM,
                        true,
                        Variant.variant().with(VariantProperties.MODEL, pOpenModelLocation).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)
                    )
                    .select(
                        Direction.WEST,
                        Half.BOTTOM,
                        true,
                        Variant.variant().with(VariantProperties.MODEL, pOpenModelLocation).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270)
                    )
                    .select(
                        Direction.NORTH,
                        Half.TOP,
    ...
    static BlockStateGenerator createPillarBlockUVLocked(
        Block pBlock, TextureMapping pTextureMapping, BiConsumer<ResourceLocation, Supplier<JsonElement>> pModelOutput
    ) {
    ...
    private void createHorizontallyRotatedBlock(Block pHorizontallyRotatedBlock, TexturedModel.Provider pProvider) {
        ...
        this.blockStateOutput
            .accept(
                MultiVariantGenerator.multiVariant(pHorizontallyRotatedBlock, Variant.variant().with(VariantProperties.MODEL, resourcelocation))
        ...
        return MultiVariantGenerator.multiVariant(pRotatedPillarBlock)
            .with(
                PropertyDispatch.property(BlockStateProperties.AXIS)
                    ...
                    .select(
                        Direction.Axis.Z,
                        Variant.variant().with(VariantProperties.MODEL, pHorizontalModelLocation).with(VariantProperties.X_ROT, VariantProperties.Rotation.R90)
                    )
                    .select(
                        Direction.Axis.X,
                        Variant.variant()
    ...
    private ResourceLocation createSuffixedVariant(
        Block pBlock, String pSuffix, ModelTemplate pModelTemplate, Function<ResourceLocation, TextureMapping> pTextureMappingGetter
    ) {
    ...
    private void copyDoorModel(Block pDoorBlock, Block pSourceBlock) {
        ...
        this.delegateItemModel(pSourceBlock, ModelLocationUtils.getModelLocation(pDoorBlock.asItem()));
        this.blockStateOutput
            .accept(
                createDoor(
                    pSourceBlock,
    ...
    private void copyTrapdoorModel(Block pTrapdoorBlock, Block pSourceBlock) {
        ...
        this.delegateItemModel(pSourceBlock, ModelLocationUtils.getModelLocation(pTrapdoorBlock.asItem()));
                        ...
                        PropertyDispatch.property(BlockStateProperties.AGE_7)
                            .generate(
                                p_176108_ -> Variant.variant()
                                        .with(VariantProperties.MODEL, ModelTemplates.STEMS[p_176108_].create(pUnattachedStemBlock, texturemapping, this.modelOutput))
                            )
                    )
            );
    }
    ...
    private void createPitcherCrop() {
        ...
        PropertyDispatch propertydispatch = PropertyDispatch.properties(PitcherCropBlock.AGE, BlockStateProperties.DOUBLE_BLOCK_HALF)
            .generate((p_277255_, p_277256_) -> {
                return switch(p_277256_) {
                    case UPPER -> Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(block, "_top_stage_" + p_277255_));
                    case LOWER -> Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(block, "_bottom_stage_" + p_277255_));
                };
            });
    ...
    private void createCommandBlock(Block pCommandBlock) {
        ...
        ResourceLocation resourcelocation1 = this.createSuffixedVariant(
            pCommandBlock, "_conditional", ModelTemplates.COMMAND_BLOCK, p_176193_ -> texturemapping.copyAndUpdate(TextureSlot.SIDE, p_176193_)
        );
        this.blockStateOutput
            .accept(
                ...
                .generate(
                    p_176172_ -> {
                        ...
                        ResourceLocation resourcelocation = int2objectmap.computeIfAbsent(
                            i, p_176098_ -> this.createSuffixedVariant(pCropBlock, "_stage" + i, ModelTemplates.CROP, TextureMapping::crop)
                        );
                        return Variant.variant().with(VariantProperties.MODEL, resourcelocation);
                    }
                );
    ...
    private void createPumpkinVariant(Block pPumpkinBlock, TextureMapping pColumnTextureMapping) {
        ...
        this.blockStateOutput
            .accept(
                MultiVariantGenerator.multiVariant(pPumpkinBlock, Variant.variant().with(VariantProperties.MODEL, resourcelocation))
                    .with(createHorizontalFacingDispatch())
            );
    }
                ...
                PropertyDispatch.properties(BlockStateProperties.LIT, BlockStateProperties.POWERED)
                    .generate(
                        (p_308471_, p_308472_) -> p_308471_
                                ? Variant.variant().with(VariantProperties.MODEL, p_308472_ ? pLitPowered : pUnlitPowered)
                                : Variant.variant().with(VariantProperties.MODEL, p_308472_ ? pLit : pUnlit)
                    )
            );
    }
    ...
    private void copyCopperBulbModel(Block pBulbBlock, Block pSourceBlock) {
        ...
        this.delegateItemModel(pSourceBlock, ModelLocationUtils.getModelLocation(pBulbBlock.asItem()));
        ...
        this.blockStateOutput
            .accept(
                MultiVariantGenerator.multiVariant(
                        pAmethystBlock,
                        Variant.variant()
                            .with(VariantProperties.MODEL, ModelTemplates.CROSS.create(pAmethystBlock, TextureMapping.cross(pAmethystBlock), this.modelOutput))
                    )
                    .with(this.createColumnWithFacing())
            );
    }
    ...
    private static List<Variant> wrapModels(List<ResourceLocation> pModelLocations, UnaryOperator<Variant> pVariantMapper) {
        return pModelLocations.stream().map(p_176238_ -> Variant.variant().with(VariantProperties.MODEL, p_176238_)).map(pVariantMapper).collect(Collectors.toList());
    }
    ...
    private void createLantern(Block pLanternBlock) {
        ...
        this.blockStateOutput
            .accept(
                MultiVariantGenerator.multiVariant(pLanternBlock)
    ...
    private void createWeightedPressurePlate(Block pPressurePlateBlock, Block pPlateMaterialBlock) {
        ...
        this.blockStateOutput
            .accept(
                MultiVariantGenerator.multiVariant(pPressurePlateBlock)
    ...
    private void createTrialSpawner() {
        ...
        this.blockStateOutput
            .accept(MultiVariantGenerator.multiVariant(block).with(PropertyDispatch.property(BlockStateProperties.TRIAL_SPAWNER_STATE).generate(p_311520_ -> {
                return switch(p_311520_) {
    ...
    private void createNormalTorch(Block pTorchBlock, Block pWallTorchBlock) {
        ...
        this.blockStateOutput
            .accept(
                MultiVariantGenerator.multiVariant(
                        pWallTorchBlock,
                        Variant.variant().with(VariantProperties.MODEL, ModelTemplates.WALL_TORCH.create(pWallTorchBlock, texturemapping, this.modelOutput))
                    )
        ...
        switch(pHatchAmount) {
            ...
            case 2:
                return ModelTemplates.TWO_TURTLE_EGGS
                    .create(ModelLocationUtils.decorateBlockModelLocation("two_" + pVariantName + "turtle_eggs"), pTextureMapping, this.modelOutput);
            case 3:
                return ModelTemplates.THREE_TURTLE_EGGS
                    .create(ModelLocationUtils.decorateBlockModelLocation("three_" + pVariantName + "turtle_eggs"), pTextureMapping, this.modelOutput);
            case 4:
                return ModelTemplates.FOUR_TURTLE_EGGS
                    .create(ModelLocationUtils.decorateBlockModelLocation("four_" + pVariantName + "turtle_eggs"), pTextureMapping, this.modelOutput);
            default:
        ...
        switch(pVariantId) {
            ...
            case 1:
                return this.createTurtleEggModel(
                    pEggAmount, "slightly_cracked_", TextureMapping.cube(TextureMapping.getBlockTexture(Blocks.TURTLE_EGG, "_slightly_cracked"))
                );
            case 2:
                return this.createTurtleEggModel(
                    pEggAmount, "very_cracked_", TextureMapping.cube(TextureMapping.getBlockTexture(Blocks.TURTLE_EGG, "_very_cracked"))
                );
            default:
                throw new UnsupportedOperationException();
        }
            ...
            .forEach(
                (p_262541_, p_262542_) -> {
                    ...
                    multipartgenerator.with(
                        ...
                        Variant.variant()
                            .with(VariantProperties.MODEL, resourcelocation)
                            .with(VariantProperties.Y_ROT, p_262542_)
                            .with(VariantProperties.UV_LOCK, true)
                    );
    ...
    private void addBookSlotModel(
        ...
        BooleanProperty pHasBookProperty,
        ...
        ResourceLocation resourcelocation = CHISELED_BOOKSHELF_SLOT_MODEL_CACHE.computeIfAbsent(
            blockmodelgenerators$bookslotmodelcachekey, p_261415_ -> pTemplate.createWithSuffix(Blocks.CHISELED_BOOKSHELF, s, texturemapping, this.modelOutput)
        );
        pGenerator.with(
            Condition.and(pCondition, Condition.condition().term(pHasBookProperty, pHasBook)),
    ...
    private void createShulkerBox(Block pShulkerBoxBlock) {
        ...
        ModelTemplates.SHULKER_BOX_INVENTORY
            .create(ModelLocationUtils.getModelLocation(pShulkerBoxBlock.asItem()), TextureMapping.particle(pShulkerBoxBlock), this.modelOutput);
    }
    ...
    private void createCandleAndCandleCake(Block pCandleBlock, Block pCandleCakeBlock) {
        ...
        ResourceLocation resourcelocation9 = ModelTemplates.CANDLE_CAKE
            .createWithSuffix(pCandleCakeBlock, "_lit", TextureMapping.candleCake(pCandleBlock, true), this.modelOutput);
        this.blockStateOutput
            .accept(
                MultiVariantGenerator.multiVariant(pCandleCakeBlock).with(createBooleanModelDispatch(BlockStateProperties.LIT, resourcelocation9, resourcelocation8))
            );
    }
    ...
    class BlockFamilyProvider {
        ...
        public BlockModelGenerators.BlockFamilyProvider donateModelTo(Block pSourceBlock, Block pBlock) {
            ...
            BlockModelGenerators.this.delegateItemModel(pBlock, resourcelocation);
        ...
        public BlockModelGenerators.BlockFamilyProvider wall(Block pWallBlock) {
            ...
            BlockModelGenerators.this.blockStateOutput
                .accept(BlockModelGenerators.createWall(pWallBlock, resourcelocation, resourcelocation1, resourcelocation2));
        ...
        public BlockModelGenerators.BlockFamilyProvider customFence(Block pFenceBlock) {
            ...
            ResourceLocation resourcelocation1 = ModelTemplates.CUSTOM_FENCE_SIDE_NORTH
                .create(pFenceBlock, texturemapping, BlockModelGenerators.this.modelOutput);
            ...
            BlockModelGenerators.this.blockStateOutput
                .accept(
                    BlockModelGenerators.createCustomFence(
                        pFenceBlock, resourcelocation, resourcelocation1, resourcelocation2, resourcelocation3, resourcelocation4
                    )
                );
        ...
        public BlockModelGenerators.BlockFamilyProvider customFenceGate(Block pCustomFenceGateBlock) {
            ...
            ResourceLocation resourcelocation1 = ModelTemplates.CUSTOM_FENCE_GATE_CLOSED
                .create(pCustomFenceGateBlock, texturemapping, BlockModelGenerators.this.modelOutput);
        ...
        public BlockModelGenerators.BlockFamilyProvider slab(Block pSlabBlock) {
            if (this.fullBlock == null) {
                ...
                BlockModelGenerators.this.blockStateOutput
                    .accept(BlockModelGenerators.createSlab(pSlabBlock, resourcelocation, resourcelocation1, this.fullBlock));
        ...
        public BlockModelGenerators.BlockFamilyProvider stairs(Block pStairsBlock) {
            ...
            BlockModelGenerators.this.blockStateOutput
                .accept(BlockModelGenerators.createStairs(pStairsBlock, resourcelocation, resourcelocation1, resourcelocation2));
        ...
        private ResourceLocation getOrCreateModel(ModelTemplate pModelTemplate, Block pBlock) {
            return this.models.computeIfAbsent(pModelTemplate, p_176268_ -> p_176268_.create(pBlock, this.mapping, BlockModelGenerators.this.modelOutput));
        }

        public BlockModelGenerators.BlockFamilyProvider generateFor(BlockFamily pFamily) {
            this.family = pFamily;
            pFamily.getVariants().forEach((p_308473_, p_308474_) -> {
    ...
    interface BlockStateGeneratorSupplier {
        BlockStateGenerator create(
            Block pBlock, ResourceLocation pModelLocation, TextureMapping pTextureMapping, BiConsumer<ResourceLocation, Supplier<JsonElement>> pModelOutput
        );
    }
    ...
    class WoodProvider {
        ...
        public BlockModelGenerators.WoodProvider logWithHorizontal(Block pLogBlock) {
            ...
            ResourceLocation resourcelocation1 = ModelTemplates.CUBE_COLUMN_HORIZONTAL
                .create(pLogBlock, this.logMapping, BlockModelGenerators.this.modelOutput);
            BlockModelGenerators.this.blockStateOutput
                .accept(BlockModelGenerators.createRotatedPillarWithHorizontalVariant(pLogBlock, resourcelocation, resourcelocation1));
            return this;
        }

        public BlockModelGenerators.WoodProvider logUVLocked(Block pLogBlock) {
            BlockModelGenerators.this.blockStateOutput
                .accept(BlockModelGenerators.createPillarBlockUVLocked(pLogBlock, this.logMapping, BlockModelGenerators.this.modelOutput));
            return this;
        }
    }
}
