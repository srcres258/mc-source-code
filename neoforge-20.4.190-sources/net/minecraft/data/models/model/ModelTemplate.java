...
public class ModelTemplate {
    ...
    public ResourceLocation createWithSuffix(
        Block pModelBlock, String pModelLocationSuffix, TextureMapping pTextureMapping, BiConsumer<ResourceLocation, Supplier<JsonElement>> pModelOutput
    ) {
    ...
    public ResourceLocation create(
        ...
        ModelTemplate.JsonFactory pFactory
    ) {
        Map<TextureSlot, ResourceLocation> map = this.createMap(pTextureMapping);
        pModelOutput.accept(pModelLocation, () -> pFactory.create(pModelLocation, map));
