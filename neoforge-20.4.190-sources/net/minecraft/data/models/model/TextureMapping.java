...
public class TextureMapping {
    ...
    public static TextureMapping pottedAzalea(Block pAzaleaBlock) {
        return new TextureMapping()
            .put(TextureSlot.PLANT, getBlockTexture(pAzaleaBlock, "_plant"))
            .put(TextureSlot.SIDE, getBlockTexture(pAzaleaBlock, "_side"))
            .put(TextureSlot.TOP, getBlockTexture(pAzaleaBlock, "_top"));
    }

    public static TextureMapping logColumn(Block pLogBlock) {
        return new TextureMapping()
            .put(TextureSlot.SIDE, getBlockTexture(pLogBlock))
            .put(TextureSlot.END, getBlockTexture(pLogBlock, "_top"))
            .put(TextureSlot.PARTICLE, getBlockTexture(pLogBlock));
    }
    ...
    public static TextureMapping fence(Block pFenceBlock) {
        return new TextureMapping()
            .put(TextureSlot.TEXTURE, getBlockTexture(pFenceBlock))
            .put(TextureSlot.SIDE, getBlockTexture(pFenceBlock, "_side"))
            .put(TextureSlot.TOP, getBlockTexture(pFenceBlock, "_top"));
    }
    ...
    public static TextureMapping columnWithWall(Block pColumnBlock) {
        ...
        return new TextureMapping()
            ...
            .put(TextureSlot.WALL, resourcelocation)
            .put(TextureSlot.SIDE, resourcelocation)
            .put(TextureSlot.END, getBlockTexture(pColumnBlock, "_top"));
    }
    ...
    public static TextureMapping trialSpawner(Block pTrialSpawnerBlock, String pSideSuffix, String pTopSuffix) {
        return new TextureMapping()
            .put(TextureSlot.SIDE, getBlockTexture(pTrialSpawnerBlock, pSideSuffix))
            .put(TextureSlot.TOP, getBlockTexture(pTrialSpawnerBlock, pTopSuffix))
            .put(TextureSlot.BOTTOM, getBlockTexture(pTrialSpawnerBlock, "_bottom"));
    }
    ...
    public static TextureMapping commandBlock(Block pCommandBlock) {
        return new TextureMapping()
            .put(TextureSlot.SIDE, getBlockTexture(pCommandBlock, "_side"))
            .put(TextureSlot.FRONT, getBlockTexture(pCommandBlock, "_front"))
            .put(TextureSlot.BACK, getBlockTexture(pCommandBlock, "_back"));
    }
    ...
    public static TextureMapping craftingTable(Block pCraftingTableBlock, Block pCraftingTableMaterialBlock) {
        return new TextureMapping()
            .put(TextureSlot.PARTICLE, getBlockTexture(pCraftingTableBlock, "_front"))
            .put(TextureSlot.DOWN, getBlockTexture(pCraftingTableMaterialBlock))
            .put(TextureSlot.UP, getBlockTexture(pCraftingTableBlock, "_top"))
            .put(TextureSlot.NORTH, getBlockTexture(pCraftingTableBlock, "_front"))
            .put(TextureSlot.EAST, getBlockTexture(pCraftingTableBlock, "_side"))
            .put(TextureSlot.SOUTH, getBlockTexture(pCraftingTableBlock, "_side"))
            .put(TextureSlot.WEST, getBlockTexture(pCraftingTableBlock, "_front"));
    }

    public static TextureMapping fletchingTable(Block pFletchingTableBlock, Block pFletchingTableMaterialBlock) {
        return new TextureMapping()
            .put(TextureSlot.PARTICLE, getBlockTexture(pFletchingTableBlock, "_front"))
            .put(TextureSlot.DOWN, getBlockTexture(pFletchingTableMaterialBlock))
            .put(TextureSlot.UP, getBlockTexture(pFletchingTableBlock, "_top"))
            .put(TextureSlot.NORTH, getBlockTexture(pFletchingTableBlock, "_front"))
            .put(TextureSlot.SOUTH, getBlockTexture(pFletchingTableBlock, "_front"))
            .put(TextureSlot.EAST, getBlockTexture(pFletchingTableBlock, "_side"))
            .put(TextureSlot.WEST, getBlockTexture(pFletchingTableBlock, "_side"));
    }

    public static TextureMapping snifferEgg(String pCrackLevel) {
        return new TextureMapping()
            .put(TextureSlot.PARTICLE, getBlockTexture(Blocks.SNIFFER_EGG, pCrackLevel + "_north"))
            .put(TextureSlot.BOTTOM, getBlockTexture(Blocks.SNIFFER_EGG, pCrackLevel + "_bottom"))
            .put(TextureSlot.TOP, getBlockTexture(Blocks.SNIFFER_EGG, pCrackLevel + "_top"))
            .put(TextureSlot.NORTH, getBlockTexture(Blocks.SNIFFER_EGG, pCrackLevel + "_north"))
            .put(TextureSlot.SOUTH, getBlockTexture(Blocks.SNIFFER_EGG, pCrackLevel + "_south"))
            .put(TextureSlot.EAST, getBlockTexture(Blocks.SNIFFER_EGG, pCrackLevel + "_east"))
            .put(TextureSlot.WEST, getBlockTexture(Blocks.SNIFFER_EGG, pCrackLevel + "_west"));
    }
    ...
    public static TextureMapping candleCake(Block pCandleCakeBlock, boolean pLit) {
        return new TextureMapping()
            ...
            .put(TextureSlot.CANDLE, getBlockTexture(pCandleCakeBlock, pLit ? "_lit" : ""));
    }
    ...
    public static TextureMapping cauldron(ResourceLocation pCauldronContentTextureLocation) {
        return new TextureMapping()
            ...
            .put(TextureSlot.CONTENT, pCauldronContentTextureLocation);
    }
    ...
    public static ResourceLocation getBlockTexture(Block pBlock, String pTextureSuffix) {
        ResourceLocation resourcelocation = BuiltInRegistries.BLOCK.getKey(pBlock);
        return resourcelocation.withPath(p_248521_ -> "block/" + p_248521_ + pTextureSuffix);
    }
    ...
    public static ResourceLocation getItemTexture(Item pItem, String pTextureSuffix) {
        ResourceLocation resourcelocation = BuiltInRegistries.ITEM.getKey(pItem);
        return resourcelocation.withPath(p_252192_ -> "item/" + p_252192_ + pTextureSuffix);
    }
}
