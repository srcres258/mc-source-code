...
public abstract class PropertyDispatch {
    ...
    public static class C1<T1 extends Comparable<T1>> extends PropertyDispatch {
        ...
        public PropertyDispatch generate(Function<T1, Variant> pPropertyValueToVariantMapper) {
            this.property1.getPossibleValues().forEach(p_125340_ -> this.select(p_125340_, pPropertyValueToVariantMapper.apply(p_125340_)));
            return this;
        }

        public PropertyDispatch generateList(Function<T1, List<Variant>> pPropertyValueToVariantsMapper) {
            this.property1.getPossibleValues().forEach(p_176312_ -> this.select(p_176312_, pPropertyValueToVariantsMapper.apply(p_176312_)));
            return this;
        }
    }
            ...
            this.property1
                ...
                .forEach(
                    p_125376_ -> this.property2
                            .getPossibleValues()
                            .forEach(p_176322_ -> this.select((T1)p_125376_, p_176322_, pPropertyValuesToVariantMapper.apply((T1)p_125376_, p_176322_)))
                );
            return this;
        }
            ...
            this.property1
                ...
                .forEach(
                    p_125366_ -> this.property2
                            .getPossibleValues()
                            .forEach(p_176318_ -> this.select((T1)p_125366_, p_176318_, pPropertyValuesToVariantsMapper.apply((T1)p_125366_, p_176318_)))
                );
            return this;
        }
    }
                                ...
                                p_176343_ -> this.property3
                                        ...
                                        .forEach(
                                            p_176339_ -> this.select(
                                                    (T1)p_125404_, (T2)p_176343_, p_176339_, pPropertyValuesToVariantMapper.apply((T1)p_125404_, (T2)p_176343_, p_176339_)
                                                )
                                        )
                            )
                );
                                ...
                                p_176331_ -> this.property3
                                        ...
                                        .forEach(
                                            p_176327_ -> this.select(
                                                    (T1)p_176334_, (T2)p_176331_, p_176327_, pPropertyValuesToVariantsMapper.apply((T1)p_176334_, (T2)p_176331_, p_176327_)
                                                )
                                        )
                            )
                );
    ...
    public static class C4<T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>, T4 extends Comparable<T4>> extends PropertyDispatch {
        ...
        public PropertyDispatch.C4<T1, T2, T3, T4> select(T1 pProperty1Value, T2 pProperty2Value, T3 pProperty3Value, T4 pProperty4Value, List<Variant> pVariants) {
            Selector selector = Selector.of(
                this.property1.value(pProperty1Value), this.property2.value(pProperty2Value), this.property3.value(pProperty3Value), this.property4.value(pProperty4Value)
            );
            this.putValue(selector, pVariants);
            return this;
        }
                                            ...
                                            p_176376_ -> this.property4
                                                    ...
                                                    .forEach(
                                                        p_176371_ -> this.select(
                                                                ...
                                                                (T3)p_176376_,
                                                                p_176371_,
                                                                pPropertyValuesToVariantMapper.apply((T1)p_176385_, (T2)p_176380_, (T3)p_176376_, p_176371_)
                                                            )
                                                    )
                                        )
                            )
                                            ...
                                            p_176356_ -> this.property4
                                                    ...
                                                    .forEach(
                                                        p_176351_ -> this.select(
                                                                ...
                                                                (T3)p_176356_,
                                                                p_176351_,
                                                                pPropertyValuesToVariantsMapper.apply((T1)p_176365_, (T2)p_176360_, (T3)p_176356_, p_176351_)
                                                            )
                                                    )
                                        )
                            )
    ...
    public static class C5<T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>, T4 extends Comparable<T4>, T5 extends Comparable<T5>>
        ...
        public PropertyDispatch.C5<T1, T2, T3, T4, T5> select(T1 pProperty1Value, T2 pProperty2Value, T3 pProperty3Value, T4 pProperty4Value, T5 pProperty5Value, List<Variant> pVariants) {
            Selector selector = Selector.of(
                this.property1.value(pProperty1Value),
                this.property2.value(pProperty2Value),
                this.property3.value(pProperty3Value),
                this.property4.value(pProperty4Value),
                this.property5.value(pProperty5Value)
            );
            this.putValue(selector, pVariants);
            return this;
        }
                                                        ...
                                                        p_176425_ -> this.property5
                                                                ...
                                                                .forEach(
                                                                    p_176419_ -> this.select(
                                                                            ...
                                                                            (T4)p_176425_,
                                                                            p_176419_,
                                                                            pPropertyValuesToVariantMapper.apply(
                                                                                (T1)p_176439_, (T2)p_176434_, (T3)p_176430_, (T4)p_176425_, p_176419_
                                                                            )
                                                                        )
                                                                )
                                                    )
                                                        ...
                                                        p_176398_ -> this.property5
                                                                ...
                                                                .forEach(
                                                                    p_176392_ -> this.select(
                                                                            ...
                                                                            (T4)p_176398_,
                                                                            p_176392_,
                                                                            pPropertyValuesToVariantsMapper.apply(
                                                                                (T1)p_176412_, (T2)p_176407_, (T3)p_176403_, (T4)p_176398_, p_176392_
                                                                            )
                                                                        )
                                                                )
                                                    )
