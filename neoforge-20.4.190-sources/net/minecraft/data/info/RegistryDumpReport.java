...
public class RegistryDumpReport implements DataProvider {
    ...
    public CompletableFuture<?> run(CachedOutput pOutput) {
        ...
        BuiltInRegistries.REGISTRY.holders().forEach(p_211088_ -> jsonobject.add(p_211088_.key().location().toString(), dumpRegistry(p_211088_.value())));
    ...
    private static <T> JsonElement dumpRegistry(Registry<T> pRegistry) {
        ...
        int i = ((Registry<Registry<T>>)BuiltInRegistries.REGISTRY).getId(pRegistry);
