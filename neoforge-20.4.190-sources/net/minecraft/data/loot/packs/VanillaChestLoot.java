...
public class VanillaChestLoot implements LootTableSubProvider {
    ...
    public void generate(BiConsumer<ResourceLocation, LootTable.Builder> pOutput) {
        ...
        pOutput.accept(BuiltInLootTables.BASTION_BRIDGE, bastionBridgeLootTable());
        pOutput.accept(BuiltInLootTables.BASTION_HOGLIN_STABLE, bastionHoglinStableLootTable());
        pOutput.accept(BuiltInLootTables.BASTION_OTHER, bastionOtherLootTable());
        pOutput.accept(BuiltInLootTables.BASTION_TREASURE, bastionTreasureLootTable());
        pOutput.accept(
        ...
        pOutput.accept(BuiltInLootTables.ANCIENT_CITY, ancientCityLootTable());
        pOutput.accept(
        ...
        pOutput.accept(BuiltInLootTables.DESERT_PYRAMID, desertPyramidLootTable());
        pOutput.accept(BuiltInLootTables.END_CITY_TREASURE, endCityTreasureLootTable());
        pOutput.accept(
        ...
        pOutput.accept(BuiltInLootTables.JUNGLE_TEMPLE, jungleTempleLootTable());
        pOutput.accept(
        ...
        pOutput.accept(BuiltInLootTables.NETHER_BRIDGE, netherBridgeLootTable());
        pOutput.accept(BuiltInLootTables.PILLAGER_OUTPOST, pillagerOutpostLootTable());
        pOutput.accept(BuiltInLootTables.SHIPWRECK_MAP, shipwreckMapLootTable());
        pOutput.accept(BuiltInLootTables.SHIPWRECK_SUPPLY, shipwreckSupplyLootTable());
        pOutput.accept(BuiltInLootTables.SHIPWRECK_TREASURE, shipwreckTreasureLootTable());
        pOutput.accept(
        ...
        pOutput.accept(BuiltInLootTables.STRONGHOLD_CORRIDOR, strongholdCorridorLootTable());
        pOutput.accept(
        ...
        pOutput.accept(BuiltInLootTables.STRONGHOLD_LIBRARY, strongholdLibraryLootTable());
        pOutput.accept(
        ...
        pOutput.accept(BuiltInLootTables.WOODLAND_MANSION, woodlandMansionLootTable());
        pOutput.accept(
        ...
        pOutput.accept(BuiltInLootTables.TRIAL_CHAMBERS_REWARD, LootTable.lootTable());
        pOutput.accept(BuiltInLootTables.TRIAL_CHAMBERS_SUPPLY, LootTable.lootTable());
        pOutput.accept(BuiltInLootTables.TRIAL_CHAMBERS_CORRIDOR, LootTable.lootTable());
        pOutput.accept(BuiltInLootTables.TRIAL_CHAMBERS_ENTRANCE, LootTable.lootTable());
        pOutput.accept(BuiltInLootTables.TRIAL_CHAMBERS_INTERSECTION, LootTable.lootTable());
        pOutput.accept(BuiltInLootTables.TRIAL_CHAMBERS_INTERSECTION_BARREL, LootTable.lootTable());
        pOutput.accept(BuiltInLootTables.TRIAL_CHAMBERS_CHAMBER_DISPENSER, LootTable.lootTable());
        pOutput.accept(BuiltInLootTables.TRIAL_CHAMBERS_CORRIDOR_DISPENSER, LootTable.lootTable());
        pOutput.accept(BuiltInLootTables.TRIAL_CHAMBERS_WATER_DISPENSER, LootTable.lootTable());
        pOutput.accept(BuiltInLootTables.TRIAL_CHAMBERS_CORRIDOR_POT, LootTable.lootTable());
        spawnerLootTables(pOutput);
    }

    public static void spawnerLootTables(BiConsumer<ResourceLocation, LootTable.Builder> pOutput) {
