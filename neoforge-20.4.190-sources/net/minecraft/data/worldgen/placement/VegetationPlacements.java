...
public class VegetationPlacements {
    ...
    public static List<PlacementModifier> treePlacement(PlacementModifier pPlacement, Block pSaplingBlock) {
        return treePlacementBase(pPlacement)
            .add(BlockPredicateFilter.forPredicate(BlockPredicate.wouldSurvive(pSaplingBlock.defaultBlockState(), BlockPos.ZERO)))
            .build();
    }
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> pContext) {
        ...
        PlacementUtils.register(
            pContext, PATCH_GRASS_BADLANDS, holder5, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome()
        );
        ...
        PlacementUtils.register(
            pContext, PATCH_GRASS_TAIGA_2, holder6, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome()
        );
