...
public class Structures {
    ...
    public static void bootstrap(BootstapContext<Structure> pContext) {
        ...
        pContext.register(
            ...
            new DesertPyramidStructure(structure(holdergetter.getOrThrow(BiomeTags.HAS_DESERT_PYRAMID), TerrainAdjustment.NONE))
        );
        ...
        pContext.register(
            ...
            new OceanRuinStructure(
                structure(holdergetter.getOrThrow(BiomeTags.HAS_OCEAN_RUIN_COLD), TerrainAdjustment.NONE), OceanRuinStructure.Type.COLD, 0.3F, 0.9F
            )
        );
        pContext.register(
            BuiltinStructures.OCEAN_RUIN_WARM,
            new OceanRuinStructure(
                structure(holdergetter.getOrThrow(BiomeTags.HAS_OCEAN_RUIN_WARM), TerrainAdjustment.NONE), OceanRuinStructure.Type.WARM, 0.3F, 0.9F
            )
        );
        pContext.register(
        ...
        pContext.register(
            ...
            new JigsawStructure(
                structure(
                    holdergetter.getOrThrow(BiomeTags.HAS_TRAIL_RUINS), Map.of(), GenerationStep.Decoration.UNDERGROUND_STRUCTURES, TerrainAdjustment.BURY
                ),
