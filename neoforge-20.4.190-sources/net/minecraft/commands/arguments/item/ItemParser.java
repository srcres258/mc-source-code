...
public class ItemParser {
    ...
    private static final DynamicCommandExceptionType ERROR_UNKNOWN_ITEM = new DynamicCommandExceptionType(
        p_304134_ -> Component.translatableEscape("argument.item.id.invalid", p_304134_)
    );
    private static final DynamicCommandExceptionType ERROR_UNKNOWN_TAG = new DynamicCommandExceptionType(
        p_304133_ -> Component.translatableEscape("arguments.item.tag.unknown", p_304133_)
    );
    ...
    public static Either<ItemParser.ItemResult, ItemParser.TagResult> parseForTesting(HolderLookup<Item> pLookup, StringReader pReader) throws CommandSyntaxException {
        ...
        try {
            ...
            return itemparser.result
                .mapBoth(p_235301_ -> new ItemParser.ItemResult(p_235301_, itemparser.nbt), p_235304_ -> new ItemParser.TagResult(p_235304_, itemparser.nbt));
        } catch (CommandSyntaxException commandsyntaxexception) {
            pReader.setCursor(i);
            throw commandsyntaxexception;
        }
