...
public class GameTestBatch {
    ...
    public GameTestBatch(
        String pName, Collection<TestFunction> pTestFunctions, @Nullable Consumer<ServerLevel> pBeforeBatchFunction, @Nullable Consumer<ServerLevel> pAfterBatchFunction
    ) {
