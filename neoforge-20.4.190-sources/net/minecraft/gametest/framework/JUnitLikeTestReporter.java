...
public class JUnitLikeTestReporter implements TestReporter {
    ...
    public void onTestFailed(GameTestInfo pTestInfo) {
        ...
        Element element = this.document.createElement(pTestInfo.isRequired() ? "failure" : "skipped");
        element.setAttribute("message", "(" + pTestInfo.getStructureBlockPos().toShortString() + ") " + s1);
