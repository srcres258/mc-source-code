...
public class Vec3i implements Comparable<Vec3i> {
    public static final Codec<Vec3i> CODEC = Codec.INT_STREAM
        .comapFlatMap(
            p_123318_ -> Util.fixedSize(p_123318_, 3).map(p_175586_ -> new Vec3i(p_175586_[0], p_175586_[1], p_175586_[2])),
    ...
    public static Codec<Vec3i> offsetCodec(int pMaxOffset) {
        return ExtraCodecs.validate(
            CODEC,
            p_274739_ -> Math.abs(p_274739_.getX()) < pMaxOffset && Math.abs(p_274739_.getY()) < pMaxOffset && Math.abs(p_274739_.getZ()) < pMaxOffset
    ...
    public Vec3i relative(Direction pDirection, int pDistance) {
        return pDistance == 0
            ? this
            : new Vec3i(
                this.getX() + pDirection.getStepX() * pDistance, this.getY() + pDirection.getStepY() * pDistance, this.getZ() + pDirection.getStepZ() * pDistance
            );
    }
