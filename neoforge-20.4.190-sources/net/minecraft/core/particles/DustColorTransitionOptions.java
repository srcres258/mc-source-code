...
public class DustColorTransitionOptions extends DustParticleOptionsBase {
    ...
    public static final Codec<DustColorTransitionOptions> CODEC = RecordCodecBuilder.create(
        p_253369_ -> p_253369_.group(
                    ExtraCodecs.VECTOR3F.fieldOf("fromColor").forGetter(p_253368_ -> p_253368_.color),
                    ExtraCodecs.VECTOR3F.fieldOf("toColor").forGetter(p_253367_ -> p_253367_.toColor),
