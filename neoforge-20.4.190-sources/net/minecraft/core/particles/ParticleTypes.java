...
public class ParticleTypes {
    ...
    public static final ParticleType<DustParticleOptions> DUST = register(
        "dust", false, DustParticleOptions.DESERIALIZER, p_123819_ -> DustParticleOptions.CODEC
    );
    public static final ParticleType<DustColorTransitionOptions> DUST_COLOR_TRANSITION = register(
        "dust_color_transition", false, DustColorTransitionOptions.DESERIALIZER, p_175841_ -> DustColorTransitionOptions.CODEC
    );
    ...
    public static final ParticleType<SculkChargeParticleOptions> SCULK_CHARGE = register(
        "sculk_charge", true, SculkChargeParticleOptions.DESERIALIZER, p_175839_ -> SculkChargeParticleOptions.CODEC
    );
    ...
    public static final ParticleType<VibrationParticleOption> VIBRATION = register(
        "vibration", true, VibrationParticleOption.DESERIALIZER, p_235911_ -> VibrationParticleOption.CODEC
    );
    ...
    public static final ParticleType<ShriekParticleOption> SHRIEK = register(
        "shriek", false, ShriekParticleOption.DESERIALIZER, p_235904_ -> ShriekParticleOption.CODEC
    );
    ...
    private static <T extends ParticleOptions> ParticleType<T> register(
        String pKey, boolean pOverrideLimiter, ParticleOptions.Deserializer<T> pDeserializer, final Function<ParticleType<T>, Codec<T>> pCodecFactory
    ) {
