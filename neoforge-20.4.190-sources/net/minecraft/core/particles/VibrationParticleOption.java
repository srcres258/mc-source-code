...
public class VibrationParticleOption implements ParticleOptions {
    public static final Codec<VibrationParticleOption> CODEC = RecordCodecBuilder.create(
        p_235978_ -> p_235978_.group(
                    PositionSource.CODEC.fieldOf("destination").forGetter(p_235982_ -> p_235982_.destination),
                    Codec.INT.fieldOf("arrival_in_ticks").forGetter(p_235980_ -> p_235980_.arrivalInTicks)
                )
