...
public class PlayerFaceRenderer {
    ...
    public static void draw(GuiGraphics pGuiGraphics, PlayerSkin pSkin, int pX, int pY, int pSize) {
        draw(pGuiGraphics, pSkin.texture(), pX, pY, pSize);
    }
    ...
    public static void draw(
        GuiGraphics pGuiGraphics, ResourceLocation pAtlasLocation, int pX, int pY, int pSize, boolean pDrawHat, boolean pUpsideDown
    ) {
