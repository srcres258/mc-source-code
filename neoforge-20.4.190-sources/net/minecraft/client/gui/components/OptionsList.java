...
public class OptionsList extends ContainerObjectSelectionList<OptionsList.Entry> {
    public OptionsList(Minecraft pMinecraft, int pWidth, int pHeight, int pY, int pItemHeight) {
    ...
    protected static class Entry extends ContainerObjectSelectionList.Entry<OptionsList.Entry> {
        ...
        public static OptionsList.Entry small(Options pOptions, int pGuiWidth, OptionInstance<?> pLeftOption, @Nullable OptionInstance<?> pRightOption) {
            ...
            return pRightOption == null
                ? new OptionsList.Entry(ImmutableMap.of(pLeftOption, abstractwidget))
                : new OptionsList.Entry(
                    ImmutableMap.of(pLeftOption, abstractwidget, pRightOption, pRightOption.createButton(pOptions, pGuiWidth / 2 - 155 + 160, 0, 150))
                );
        }
