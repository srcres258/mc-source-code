    ...
    public void render(GuiGraphics pGuiGraphics) {
        if (!this.events.isEmpty()) {
            ...
            for(LerpingBossEvent lerpingbossevent : this.events.values()) {
                int k = i / 2 - 91;
                var event = net.neoforged.neoforge.client.ClientHooks.onCustomizeBossEventProgress(pGuiGraphics, this.minecraft.getWindow(), lerpingbossevent, k, j, 10 + this.minecraft.font.lineHeight);
                if (!event.isCanceled()) {
