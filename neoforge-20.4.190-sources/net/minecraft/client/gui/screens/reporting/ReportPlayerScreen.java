...
public class ReportPlayerScreen extends Screen {
    ...
    protected void init() {
        ...
        Button button = this.layout
            .addChild(
                Button.builder(
                        REPORT_CHAT, p_299895_ -> this.minecraft.setScreen(new ChatReportScreen(this.lastScreen, this.context, this.player.getPlayerId()))
                    )
                    .build()
            );
