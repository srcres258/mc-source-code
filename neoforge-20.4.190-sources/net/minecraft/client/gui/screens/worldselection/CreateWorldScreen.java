...
public class CreateWorldScreen extends Screen {
    ...
    public static CreateWorldScreen createFromExisting(
        ...
        CreateWorldScreen createworldscreen = new CreateWorldScreen(
            ...
            pLastScreen,
            pSettings,
            WorldPresets.fromSettings(pSettings.selectedDimensions().dimensions()),
            OptionalLong.of(pSettings.options().seed())
        );
                                ...
                                new ConfirmScreen(
                                    p_269627_ -> {
                                        if (p_269627_) {
                                            ...
                                            pConsumer.accept(new WorldDataConfiguration(new DataPackConfig(ImmutableList.of("vanilla"), ImmutableList.of()), FeatureFlags.VANILLA_SET)); // FORGE: Revert to *actual* vanilla data
                                        }
                                    },
