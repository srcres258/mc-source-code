...
public class CreateBuffetWorldScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(
            Button.builder(CommonComponents.GUI_CANCEL, p_280789_ -> this.minecraft.setScreen(this.parent))
    ...
    class BiomeList extends ObjectSelectionList<CreateBuffetWorldScreen.BiomeList.Entry> {
        BiomeList() {
            ...
            CreateBuffetWorldScreen.this.biomes
                .holders()
                .map(p_205389_ -> new CreateBuffetWorldScreen.BiomeList.Entry(p_205389_))
