...
public class BanNoticeScreens {
    ...
    public static ConfirmLinkScreen create(BooleanConsumer pCallback, BanDetails pBanDetails) {
        return new ConfirmLinkScreen(
            pCallback, getBannedTitle(pBanDetails), getBannedScreenText(pBanDetails), "https://aka.ms/mcjavamoderation", CommonComponents.GUI_ACKNOWLEDGE, true
        );
    }
    ...
    private static Component getBannedScreenText(BanDetails pBanDetails) {
        return Component.translatable(
            "gui.banned.description", getBanReasonText(pBanDetails), getBanStatusText(pBanDetails), Component.literal("https://aka.ms/mcjavamoderation")
        );
    }
