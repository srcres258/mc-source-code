...
public class Font implements net.neoforged.neoforge.client.extensions.IFontExtension {
    ...
    public int drawInBatch(
        ...
        return this.drawInBatch(
            pText, pX, pY, pColor, pDropShadow, pMatrix, pBuffer, pDisplayMode, pBackgroundColor, pPackedLightCoords, this.isBidirectional()
        );
    }
    ...
    public int drawInBatch(
        ...
        return this.drawInBatch(
            pText.getVisualOrderText(), pX, pY, pColor, pDropShadow, pMatrix, pBuffer, pDisplayMode, pBackgroundColor, pPackedLightCoords
        );
    }
    ...
    public void drawInBatch8xOutline(
        ...
        Font.StringRenderOutput font$stringrenderoutput = new Font.StringRenderOutput(
            pBufferSource, 0.0F, 0.0F, i, false, pMatrix, Font.DisplayMode.NORMAL, pPackedLightCoords
        );
        ...
        Font.StringRenderOutput font$stringrenderoutput1 = new Font.StringRenderOutput(
            pBufferSource, pX, pY, adjustColor(pColor), false, pMatrix, Font.DisplayMode.POLYGON_OFFSET, pPackedLightCoords
        );
    ...
    private static int adjustColor(int pColor) {
        return (pColor & -67108864) == 0 ? pColor | 0xFF000000 : pColor;
    }
    ...
    private float renderText(
        ...
        Font.StringRenderOutput font$stringrenderoutput = new Font.StringRenderOutput(
            pBuffer, pX, pY, pColor, pDropShadow, pMatrix, pDisplayMode, pPackedLightCoords
        );
    ...
    class StringRenderOutput implements FormattedCharSink {
        ...
        public StringRenderOutput(
            ...
            this.r = (float)(pColor >> 16 & 0xFF) / 255.0F * this.dimFactor;
            this.g = (float)(pColor >> 8 & 0xFF) / 255.0F * this.dimFactor;
            this.b = (float)(pColor & 0xFF) / 255.0F * this.dimFactor;
            this.a = (float)(pColor >> 24 & 0xFF) / 255.0F;
            this.pose = pPose;
            this.mode = pMode;
         ...
         *
         * @param pPositionInCurrentSequence Contains the relative position of the
        ...
        public boolean accept(int pPositionInCurrentSequence, Style pStyle, int pCodePoint) {
            ...
            if (!(bakedglyph instanceof EmptyGlyph)) {
                ...
                Font.this.renderChar(
                    bakedglyph, flag, pStyle.isItalic(), f5, this.x + f4, this.y + f4, this.pose, vertexconsumer, f, f1, f2, f3, this.packedLightCoords
                );
            }
        ...
        public float finish(int pBackgroundColor, float pX) {
            if (pBackgroundColor != 0) {
                float f = (float)(pBackgroundColor >> 24 & 0xFF) / 255.0F;
                float f1 = (float)(pBackgroundColor >> 16 & 0xFF) / 255.0F;
                float f2 = (float)(pBackgroundColor >> 8 & 0xFF) / 255.0F;
                float f3 = (float)(pBackgroundColor & 0xFF) / 255.0F;
