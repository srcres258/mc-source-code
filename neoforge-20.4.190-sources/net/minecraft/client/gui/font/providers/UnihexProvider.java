...
public class UnihexProvider implements GlyphProvider {
    ...
    public static class Definition implements GlyphProviderDefinition {
        ...
        private UnihexProvider loadData(InputStream pInputStream) throws IOException {
            CodepointMap<UnihexProvider.LineData> codepointmap = new CodepointMap<>(
                p_286908_ -> new UnihexProvider.LineData[p_286908_], p_286615_ -> new UnihexProvider.LineData[p_286615_][]
            );
            ...
            try (ZipInputStream zipinputstream = new ZipInputStream(pInputStream)) {
                ...
                CodepointMap<UnihexProvider.Glyph> codepointmap1 = new CodepointMap<>(
                    p_286831_ -> new UnihexProvider.Glyph[p_286831_], p_286340_ -> new UnihexProvider.Glyph[p_286340_][]
                );
