...
public class FontSet implements AutoCloseable {
    ...
    private final CodepointMap<BakedGlyph> glyphs = new CodepointMap<>(p_284630_ -> new BakedGlyph[p_284630_], p_284629_ -> new BakedGlyph[p_284629_][]);
    private final CodepointMap<FontSet.GlyphInfoFilter> glyphInfos = new CodepointMap<>(
        p_284631_ -> new FontSet.GlyphInfoFilter[p_284631_], p_284632_ -> new FontSet.GlyphInfoFilter[p_284632_][]
    );
