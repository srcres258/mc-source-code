...
public class ItemColors {
    ...
    public static ItemColors createDefault(BlockColors pColors) {
        ...
        net.neoforged.neoforge.client.ClientHooks.onItemColorsInit(itemcolors, pColors);
        return itemcolors;
    }

    public int getColor(ItemStack pStack, int pTintIndex) {
        ItemColor itemcolor = this.itemColors.get(pStack.getItem());
 ...
 */
    ...
    public void register(ItemColor pItemColor, ItemLike... pItems) {
        for(ItemLike itemlike : pItems) {
            this.itemColors.put(itemlike.asItem(), pItemColor);
        }
    }
}
