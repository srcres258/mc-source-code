...
public class LocalPlayer extends AbstractClientPlayer {
    ...
    private boolean suffocatesAt(BlockPos pPos) {
        ...
        AABB aabb1 = new AABB(
                (double)pPos.getX(), aabb.minY, (double)pPos.getZ(), (double)pPos.getX() + 1.0, aabb.maxY, (double)pPos.getZ() + 1.0
            )
            .deflate(1.0E-7);
    ...
    public void playSound(SoundEvent pSound, float pVolume, float pPitch) {
        ...
        net.neoforged.neoforge.event.PlayLevelSoundEvent.AtEntity event = net.neoforged.neoforge.event.EventHooks.onPlaySoundAtEntity(this, holder, this.getSoundSource(), pVolume, pPitch);
