...
public class MouseHandler {
    ...
    private void onPress(long pWindowPointer, int pButton, int pAction, int pModifiers) {
        if (pWindowPointer == this.minecraft.getWindow().getWindow()) {
            ...
            if (net.neoforged.neoforge.client.ClientHooks.onMouseButtonPre(pButton, pAction, pModifiers)) return;
            ...
            net.neoforged.neoforge.client.ClientHooks.onMouseButtonPost(pButton, pAction, pModifiers);
        }
    }
