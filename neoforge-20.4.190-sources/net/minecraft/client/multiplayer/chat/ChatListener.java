...
public class ChatListener {
    ...
    public void handleDisguisedChatMessage(Component pMessage, ChatType.Bound pBoundChatType) {
        ...
        this.handleMessage(null, () -> {
            ...
            Component forgeComponent = net.neoforged.neoforge.client.ClientHooks.onClientChat(pBoundChatType, component, Util.NIL_UUID);
    ...
    private boolean showMessageToPlayer(
        ...
        if (pOnlyShowSecureChat && chattrustlevel.isNotSecure()) {
            ...
            if (filtermask.isEmpty()) {
                Component forgeComponent = net.neoforged.neoforge.client.ClientHooks.onClientPlayerChat(pBoundChatType, pDecoratedServerContent, pChatMessage, pChatMessage.sender());
                if (forgeComponent == null) return false;
                ...
                if (component != null) {
                    Component forgeComponent = net.neoforged.neoforge.client.ClientHooks.onClientPlayerChat(pBoundChatType, pBoundChatType.decorate(component), pChatMessage, pChatMessage.sender());
                    if (forgeComponent == null) return false;
                    this.minecraft.gui.getChat().addMessage(forgeComponent, messagesignature, guimessagetag);
    ...
    public void handleSystemMessage(Component pMessage, boolean pIsOverlay) {
        if (!this.minecraft.options.hideMatchedNames().get() || !this.minecraft.isBlocked(this.guessChatUUID(pMessage))) {
            pMessage = net.neoforged.neoforge.client.ClientHooks.onClientSystemChat(pMessage, pIsOverlay);
