        ...
        if (pWindowPointer == this.minecraft.getWindow().getWindow()) {
            ...
            if (this.minecraft.getNarrator().isActive() && this.minecraft.options.narratorHotkey().get()) {
                ...
                label155: {
                    if (screen != null) {
                        ...
                        if ($$15 instanceof EditBox editbox && editbox.canConsumeInput()) {
                            flag7 = false;
                            break label155;
                        }
                    }
            ...
            if (screen != null) {
                ...
                Screen.wrapScreenError(() -> {
                    if (pAction == 1 || pAction == 2) {
                        ...
                        aboolean[0] = net.neoforged.neoforge.client.ClientHooks.onScreenKeyPressedPre(screen, pKey, pScanCode, pModifiers);
                        if (!aboolean[0]) aboolean[0] = screen.keyPressed(pKey, pScanCode, pModifiers);
                        if (!aboolean[0]) aboolean[0] = net.neoforged.neoforge.client.ClientHooks.onScreenKeyPressedPost(screen, pKey, pScanCode, pModifiers);
                    } else if (pAction == 0) {
                        aboolean[0] = net.neoforged.neoforge.client.ClientHooks.onScreenKeyReleasedPre(screen, pKey, pScanCode, pModifiers);
                        if (!aboolean[0]) aboolean[0] = screen.keyReleased(pKey, pScanCode, pModifiers);
                        if (!aboolean[0]) aboolean[0] = net.neoforged.neoforge.client.ClientHooks.onScreenKeyReleasedPost(screen, pKey, pScanCode, pModifiers);
                    }
            ...
            label185: {
                ...
                if (!flag3) {
                    ...
                    if (screen1 instanceof PauseScreen pausescreen && !pausescreen.showsPauseMenu()) {
                        break label144;
                    }
            ...
            net.neoforged.neoforge.client.ClientHooks.onKeyInput(pKey, pScanCode, pAction, pModifiers);
        }
    }
        ...
        if (pWindowPointer == this.minecraft.getWindow().getWindow()) {
            ...
            if (guieventlistener != null && this.minecraft.getOverlay() == null) {
                if (Character.charCount(pCodePoint) == 1) {
                    Screen.wrapScreenError(() -> {
                        if (net.neoforged.neoforge.client.ClientHooks.onScreenCharTypedPre(guieventlistener, (char)pCodePoint, pModifiers)) return;
                        if (guieventlistener.charTyped((char)pCodePoint, pModifiers)) return;
                        net.neoforged.neoforge.client.ClientHooks.onScreenCharTypedPost(guieventlistener, (char)pCodePoint, pModifiers);
                    }, "charTyped event handler", guieventlistener.getClass().getCanonicalName());
                } else {
                    for(char c0 : Character.toChars(pCodePoint)) {
                        Screen.wrapScreenError(() -> {
                            if (net.neoforged.neoforge.client.ClientHooks.onScreenCharTypedPre(guieventlistener, c0, pModifiers)) return;
                            if (guieventlistener.charTyped(c0, pModifiers)) return;
                            net.neoforged.neoforge.client.ClientHooks.onScreenCharTypedPost(guieventlistener, c0, pModifiers);
                        }, "charTyped event handler", guieventlistener.getClass().getCanonicalName());
                    }
                }
            }
