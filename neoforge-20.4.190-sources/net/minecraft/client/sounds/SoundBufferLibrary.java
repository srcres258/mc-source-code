...
public class SoundBufferLibrary {
     ...
     * @param pIsWrapper        whether the {@linkplain AudioStream} should be a {@
    ...
    public CompletableFuture<?> preload(Collection<Sound> pSounds) {
        return CompletableFuture.allOf(
            pSounds.stream().map(p_120197_ -> this.getCompleteBuffer(p_120197_.getPath())).toArray(p_120195_ -> new CompletableFuture[p_120195_])
        );
    }
}
