...
public class BreezeModel<T extends Breeze> extends HierarchicalModel<T> {
    ...
    public BreezeModel(ModelPart pRoot) {
        ...
        this.root = pRoot;
        this.windBody = pRoot.getChild("wind_body");
    ...
    public void setupAnim(T pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
        ...
        this.animate(pEntity.shoot, BreezeAnimation.SHOOT, pAgeInTicks);
        this.animate(pEntity.slide, BreezeAnimation.SLIDE, pAgeInTicks);
        this.animate(pEntity.longJump, BreezeAnimation.JUMP, pAgeInTicks);
    }
