...
public class HoglinModel<T extends Mob & HoglinBase> extends AgeableListModel<T> {
    ...
    public void setupAnim(T pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
        this.rightEar.zRot = (float) (-Math.PI * 2.0 / 9.0) - pLimbSwingAmount * Mth.sin(pLimbSwing);
        this.leftEar.zRot = (float) (Math.PI * 2.0 / 9.0) + pLimbSwingAmount * Mth.sin(pLimbSwing);
