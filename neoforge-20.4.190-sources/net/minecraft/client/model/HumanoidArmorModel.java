...
public class HumanoidArmorModel<T extends LivingEntity> extends HumanoidModel<T> {
    ...
    public static MeshDefinition createBodyLayer(CubeDeformation pCubDeformation) {
        ...
        partdefinition.addOrReplaceChild(
            "right_leg",
            CubeListBuilder.create().texOffs(0, 16).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, pCubDeformation.extend(-0.1F)),
            PartPose.offset(-1.9F, 12.0F, 0.0F)
        );
        partdefinition.addOrReplaceChild(
            "left_leg",
            CubeListBuilder.create().texOffs(0, 16).mirror().addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, pCubDeformation.extend(-0.1F)),
            PartPose.offset(1.9F, 12.0F, 0.0F)
        );
