...
public class ModelBlockRenderer {
    ...
    public void tesselateBlock(
        ...
        tesselateBlock(pLevel, pModel, pState, pPos, pPoseStack, pConsumer, pCheckSides, pRandom, pSeed, pPackedOverlay, net.neoforged.neoforge.client.model.data.ModelData.EMPTY, null);
    }
    public void tesselateBlock(
    ...
    public void tesselateWithAO(
        ...
        int pPackedOverlay
         ...
         tesselateWithAO(pLevel, pModel, pState, pPos, pPoseStack, pConsumer, pCheckSides, pRandom, pSeed, pPackedOverlay, net.neoforged.neoforge.client.model.data.ModelData.EMPTY, null);
    }
    public void tesselateWithAO(
    ...
    public void tesselateWithoutAO(
        ...
        tesselateWithoutAO(pLevel, pModel, pState, pPos, pPoseStack, pConsumer, pCheckSides, pRandom, pSeed, pPackedOverlay, net.neoforged.neoforge.client.model.data.ModelData.EMPTY, null);
    }
    public void tesselateWithoutAO(
     ...
     * @param pShapeFlags the bit set to store the shape flags in. The first bit will
     ...
     * @param pShapeFlags  the bit set to store the shape flags in. The first bit will
     *                     be {@code true} if the face should be offset, and the
     *                     second if the face is less than a block in width and height
     *                     .
     */
    private void renderModelFaceFlat(
        ...
        for(BakedQuad bakedquad : pQuads) {
            ...
            this.putQuadData(
                pLevel, pState, pPos, pConsumer, pPoseStack.last(), bakedquad, f, f, f, f, pPackedLight, pPackedLight, pPackedLight, pPackedLight, pPackedOverlay
            );
        }
    }
    ...
    public void renderModel(
        ...
        renderModel(pPose, pConsumer, pState, pModel, pRed, pGreen, pBlue, pPackedLight, pPackedOverlay, net.neoforged.neoforge.client.model.data.ModelData.EMPTY, null);
    }
    ...
    protected static enum AdjacencyInfo {
        ...
        /**
         * @param pShadeBrightness the shade brightness for this direction
         */
        private AdjacencyInfo(
            Direction[] pCorners,
            float pShadeBrightness,
            boolean pDoNonCubicWeight,
            ModelBlockRenderer.SizeInfo[] pVert0Weights,
            ModelBlockRenderer.SizeInfo[] pVert1Weights,
            ModelBlockRenderer.SizeInfo[] pVert2Weights,
            ModelBlockRenderer.SizeInfo[] pVert3Weights
        ) {
