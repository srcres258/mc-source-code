...
public class BlockRenderDispatcher implements ResourceManagerReloadListener {
    ...
    public void renderBreakingTexture(BlockState pState, BlockPos pPos, BlockAndTintGetter pLevel, PoseStack pPoseStack, VertexConsumer pConsumer) {
         renderBreakingTexture(pState, pPos, pLevel, pPoseStack, pConsumer, net.neoforged.neoforge.client.model.data.ModelData.EMPTY);
    }
    ...
    public void renderBatched(
        ...
        renderBatched(pState, pPos, pLevel, pPoseStack, pConsumer, pCheckSides, pRandom, net.neoforged.neoforge.client.model.data.ModelData.EMPTY, null);
    }
    public void renderBatched(
    ...
    public void renderLiquid(BlockPos pPos, BlockAndTintGetter pLevel, VertexConsumer pConsumer, BlockState pBlockState, FluidState pFluidState) {
        try {
            if (net.neoforged.neoforge.client.extensions.common.IClientFluidTypeExtensions.of(pFluidState).renderFluid(pFluidState, pLevel, pPos, pConsumer, pBlockState)) return;
    ...
    public void renderSingleBlock(BlockState pState, PoseStack pPoseStack, MultiBufferSource pBufferSource, int pPackedLight, int pPackedOverlay) {
        renderSingleBlock(pState, pPoseStack, pBufferSource, pPackedLight, pPackedOverlay, net.neoforged.neoforge.client.model.data.ModelData.EMPTY, null);
    }
