...
public class LiquidBlockRenderer {
    ...
    public void tesselate(BlockAndTintGetter pLevel, BlockPos pPos, VertexConsumer pVertexConsumer, BlockState pBlockState, FluidState pFluidState) {
        ...
        TextureAtlasSprite[] atextureatlassprite = net.neoforged.neoforge.client.textures.FluidSpriteCache.getFluidSprites(pLevel, pPos, pFluidState);
        ...
        if (flag1 || flag2 || flag6 || flag5 || flag3 || flag4) {
            ...
            for(Direction direction : Direction.Plane.HORIZONTAL) {
                ...
                if (flag7
                    && !isFaceOccludedByNeighbor(pLevel, pPos, direction, Math.max(f44, f45), pLevel.getBlockState(pPos.relative(direction)))) {
