...
public class RenderBuffers {
    ...
    public RenderBuffers(int pBufferCount) {
        ...
        SortedMap<RenderType, BufferBuilder> sortedmap = Util.make(new Object2ObjectLinkedOpenHashMap<>(), p_307112_ -> {
            ...
            put(p_307112_, Sheets.shieldSheet());
            put(p_307112_, Sheets.bedSheet());
            put(p_307112_, Sheets.shulkerBoxSheet());
            put(p_307112_, Sheets.signSheet());
            put(p_307112_, Sheets.hangingSignSheet());
            p_307112_.put(Sheets.chestSheet(), new BufferBuilder(786432));
            put(p_307112_, RenderType.armorGlint());
            put(p_307112_, RenderType.armorEntityGlint());
            put(p_307112_, RenderType.glint());
            put(p_307112_, RenderType.glintDirect());
            put(p_307112_, RenderType.glintTranslucent());
            put(p_307112_, RenderType.entityGlint());
            put(p_307112_, RenderType.entityGlintDirect());
