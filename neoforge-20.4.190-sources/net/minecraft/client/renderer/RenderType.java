...
public abstract class RenderType extends RenderStateShard {
    ...
    private static RenderType.CompositeRenderType createArmorCutoutNoCull(String pName, ResourceLocation pId, boolean p_298490_) {
        RenderType.CompositeState rendertype$compositestate = RenderType.CompositeState.builder()
    ...
    public static RenderType text(ResourceLocation pLocation) {
        return net.neoforged.neoforge.client.NeoForgeRenderTypes.getText(pLocation);
    }
    ...
    public static RenderType textIntensity(ResourceLocation pId) {
        return net.neoforged.neoforge.client.NeoForgeRenderTypes.getTextIntensity(pId);
    }

    public static RenderType textPolygonOffset(ResourceLocation pId) {
        return net.neoforged.neoforge.client.NeoForgeRenderTypes.getTextPolygonOffset(pId);
    }

    public static RenderType textIntensityPolygonOffset(ResourceLocation pId) {
        return net.neoforged.neoforge.client.NeoForgeRenderTypes.getTextIntensityPolygonOffset(pId);
    }

    public static RenderType textSeeThrough(ResourceLocation pLocation) {
        return net.neoforged.neoforge.client.NeoForgeRenderTypes.getTextSeeThrough(pLocation);
    }
    ...
    public static RenderType textIntensitySeeThrough(ResourceLocation pId) {
        return net.neoforged.neoforge.client.NeoForgeRenderTypes.getTextIntensitySeeThrough(pId);
    }
