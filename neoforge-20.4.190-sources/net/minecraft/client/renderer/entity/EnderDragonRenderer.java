...
public class EnderDragonRenderer extends EntityRenderer<EnderDragon> {
    ...
    public void render(EnderDragon pEntity, float pEntityYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
        ...
        if (pEntity.nearestCrystal != null) {
            ...
            renderCrystalBeams(
                f6, f8 + EndCrystalRenderer.getY(pEntity.nearestCrystal, pPartialTicks), f9, pPartialTicks, pEntity.tickCount, pPoseStack, pBuffer, pPackedLight
            );
            pPoseStack.popPose();
        }
    ...
    public static void renderCrystalBeams(
        ...
        for(int j = 1; j <= 8; ++j) {
            ...
            vertexconsumer.vertex(matrix4f, f4 * 0.2F, f5 * 0.2F, 0.0F)
                ...
                .endVertex();
            vertexconsumer.vertex(matrix4f, f4, f5, f1)
                ...
                .normal(matrix3f, 0.0F, -1.0F, 0.0F)
                .endVertex();
            vertexconsumer.vertex(matrix4f, f7, f8, f1)
                .color(255, 255, 255, 255)
                .uv(f9, f3)
                .overlayCoords(OverlayTexture.NO_OVERLAY)
                .uv2(pPackedLight)
