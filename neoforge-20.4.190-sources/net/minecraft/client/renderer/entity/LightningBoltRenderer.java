...
public class LightningBoltRenderer extends EntityRenderer<LightningBolt> {
    ...
    private static void quad(
        ...
        pConsumer.vertex(pMatrix, pX1 + (p_115285_ ? p_115284_ : -p_115284_), (float)(pIndex * 16), pZ1 + (p_115286_ ? p_115284_ : -p_115284_))
        ...
        pConsumer.vertex(
            ...
            .color(pRed, pGreen, pBlue, 0.3F)
            .endVertex();
        pConsumer.vertex(pMatrix, pX1 + (p_115287_ ? p_115284_ : -p_115284_), (float)(pIndex * 16), pZ1 + (p_115288_ ? p_115284_ : -p_115284_))
            .color(pRed, pGreen, pBlue, 0.3F)
            .endVertex();
    }
