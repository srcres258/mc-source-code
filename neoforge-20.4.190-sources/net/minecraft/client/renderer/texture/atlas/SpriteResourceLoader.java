...
public interface SpriteResourceLoader {
    ...
    static SpriteResourceLoader create(Collection<MetadataSectionSerializer<?>> pSectionSerializers) {
        return (p_293680_, p_293681_, constructor) -> {
            ResourceMetadata resourcemetadata;
            try {
                resourcemetadata = p_293681_.metadata().copySections(pSectionSerializers);
    ...
    @Nullable
    default SpriteContents loadSprite(ResourceLocation pLocation, Resource pResource) {
        return loadSprite(pLocation, pResource, SpriteContents::new);
    }
