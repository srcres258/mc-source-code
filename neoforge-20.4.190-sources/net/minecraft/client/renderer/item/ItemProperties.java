...
public class ItemProperties {
    ...
    static {
        ...
        ClampedItemPropertyFunction clampeditempropertyfunction = (p_309410_, p_309411_, p_309412_, p_309413_) -> {
            if (!p_309410_.is(ItemTags.TRIMMABLE_ARMOR)) {
                return Float.NEGATIVE_INFINITY;
            } else {
                return p_309411_ == null
                    ? 0.0F
                    : ArmorTrim.getTrim(p_309411_.registryAccess(), p_309410_, true)
        ...
        register(
            ...
            new CompassItemPropertyFunction(
                (p_234992_, p_234993_, p_234994_) -> CompassItem.isLodestoneCompass(p_234993_)
                        ? CompassItem.getLodestonePosition(p_234993_.getOrCreateTag())
                        : CompassItem.getSpawnPosition(p_234992_)
            )
        );
        register(
        ...
        register(
            ...
            (p_275887_, p_275888_, p_275889_, p_275890_) -> CrossbowItem.isCharged(p_275887_)
                        && CrossbowItem.containsChargedProjectile(p_275887_, Items.FIREWORK_ROCKET)
                    ? 1.0F
                    : 0.0F
        );
