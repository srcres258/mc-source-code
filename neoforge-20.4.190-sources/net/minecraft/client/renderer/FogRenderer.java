...
public class FogRenderer {
    ...
    public static void setupColor(Camera pActiveRenderInfo, float pPartialTicks, ClientLevel pLevel, int pRenderDistanceChunks, float pBossColorModifier) {
        ...
        if (fogtype == FogType.WATER) {
            ...
            Vec3 vec31 = pActiveRenderInfo.getPosition().subtract(2.0, 2.0, 2.0).scale(0.25);
        ...
        if (fogrenderer$mobeffectfogfunction != null) {
            ...
            f5 = fogrenderer$mobeffectfogfunction.getModifiedVoidDarkness(
                livingentity, livingentity.getEffect(fogrenderer$mobeffectfogfunction.getMobEffect()), f5, pPartialTicks
            );
        }
        ...
        Vector3f fogColor = net.neoforged.neoforge.client.ClientHooks.getFogColor(pActiveRenderInfo, pPartialTicks, pLevel, pRenderDistanceChunks, pBossColorModifier, fogRed, fogGreen, fogBlue);
    ...
    public static void setupFog(Camera pCamera, FogRenderer.FogMode pFogMode, float pFarPlaneDistance, boolean p_234176_, float p_234177_) {
        ...
        net.neoforged.neoforge.client.ClientHooks.onFogRender(pFogMode, fogtype, pCamera, p_234177_, pFarPlaneDistance, fogrenderer$fogdata.start, fogrenderer$fogdata.end, fogrenderer$fogdata.shape);
    }
