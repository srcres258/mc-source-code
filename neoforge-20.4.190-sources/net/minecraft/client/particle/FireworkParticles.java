...
public class FireworkParticles {
    ...
    public static class Starter extends NoRenderParticle {
        ...
        public void tick() {
            ...
            if (this.life % 2 == 0 && this.explosions != null && this.life / 2 < this.explosions.size()) {
                ...
                switch(fireworkrocketitem$shape) {
                    case SMALL_BALL:
                    default:
                        this.createParticleBall(0.25, 2, aint, aint1, flag4, flag2);
                        break;
                    case LARGE_BALL:
                        this.createParticleBall(0.5, 4, aint, aint1, flag4, flag2);
                        break;
                    case STAR:
        ...
        public void createParticleShape(
            double pSpeed, double[][] pShape, int[] pColours, int[] pFadeColours, boolean pTrail, boolean pTwinkle, boolean pCreeper
        ) {
            double d0 = pShape[0][0];
            double d1 = pShape[0][1];
            this.createParticle(this.x, this.y, this.z, d0 * pSpeed, d1 * pSpeed, 0.0, pColours, pFadeColours, pTrail, pTwinkle);
