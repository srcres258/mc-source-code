...
public class SquidInkParticle extends SimpleAnimatedParticle {
    ...
    public static class GlowInkProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
            ...
            return new SquidInkParticle(
                pLevel, pX, pY, pZ, pXSpeed, pYSpeed, pZSpeed, FastColor.ARGB32.color(255, 204, 31, 102), this.sprites
            );
        }
    }
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
            ...
            return new SquidInkParticle(
                pLevel, pX, pY, pZ, pXSpeed, pYSpeed, pZSpeed, FastColor.ARGB32.color(255, 255, 255, 255), this.sprites
            );
        }
    }
}
