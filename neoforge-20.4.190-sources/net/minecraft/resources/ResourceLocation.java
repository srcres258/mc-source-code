...
public class ResourceLocation implements Comparable<ResourceLocation> {
    ...
    /**
     * Constructs a {@code ResourceLocation} from the specified {@code location}, split into a namespace and path by the specified {@code separator} char.
     * <p>
     * If the {@code separator} char is not present in the {@code location}, the namespace defaults to {@code minecraft}, taking the {@code location} as the path.
     * @throws net.minecraft.ResourceLocationException if there is a non {@code [a-z0-9_.-]} character in the decomposed namespace or a non {@code [a-z0-9/._-]} character in the decomposed path.
     * @see #tryParse(String)
     * @see #isValidResourceLocation(String)
     *
     * @param pLocation  the location string to parse as a {@code ResourceLocation}
     * @param pSeparator the separator to separate the namespace and path by. This
     *                   should not be any of these characters: {@code [a-z0-9/._-]}.
     */
     ...
     * @see #of(String, char)
     *
     * @param pLocation the location string to try to parse as a {@code
     *                  ResourceLocation}
     */
    @Nullable
     ...
     * <p>
     * If no colon is present in the {@code location}, the namespace defaults to {@code minecraft}, taking the {@code location} as the path.</p>
