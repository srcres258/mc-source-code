...
public class Main {
    ...
    private static void forceUpgrade(
        LevelStorageSource.LevelStorageAccess pLevelStorage, DataFixer pDataFixer, boolean pEraseCache, BooleanSupplier pUpgradeWorld, Registry<LevelStem> pDimesions
    ) {
