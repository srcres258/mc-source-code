...
public class ServerEntity {
    ...
    public void sendChanges() {
        ...
        if (!list.equals(this.lastPassengers)) {
            ...
            removedPassengers(list, this.lastPassengers)
                .forEach(
                    p_311547_ -> {
                        if (p_311547_ instanceof ServerPlayer serverplayer1) {
    ...
    public void removePairing(ServerPlayer pPlayer) {
        ...
        net.neoforged.neoforge.event.EventHooks.onStopEntityTracking(this.entity, pPlayer);
    }

    public void addPairing(ServerPlayer pPlayer) {
        List<Packet<? super ClientGamePacketListener>> list = new ArrayList<>();
        this.sendPairingData(pPlayer, new net.neoforged.neoforge.network.bundle.PacketAndPayloadAcceptor<>(list::add));
        pPlayer.connection.send(new ClientboundBundlePacket(list));
        this.entity.startSeenByPlayer(pPlayer);
        net.neoforged.neoforge.event.EventHooks.onStartEntityTracking(this.entity, pPlayer);
    }
    ...
    public void sendPairingData(ServerPlayer p_289562_, net.neoforged.neoforge.network.bundle.PacketAndPayloadAcceptor<net.minecraft.network.protocol.game.ClientGamePacketListener> p_289563_) {
        ...
        if (entityx instanceof Mob mob && mob.isLeashed()) {
