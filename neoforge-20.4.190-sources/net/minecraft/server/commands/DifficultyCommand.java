...
public class DifficultyCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> pDispatcher) {
        ...
        pDispatcher.register(literalargumentbuilder.requires(p_136943_ -> p_136943_.hasPermission(2)).executes(p_313472_ -> {
            Difficulty difficulty1 = p_313472_.getSource().getLevel().getDifficulty();
            p_313472_.getSource().sendSuccess(() -> Component.translatable("commands.difficulty.query", difficulty1.getDisplayName()), false);
