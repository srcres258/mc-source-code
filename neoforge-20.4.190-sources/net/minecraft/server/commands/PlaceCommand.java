...
public class PlaceCommand {
    ...
    public static int placeStructure(CommandSourceStack pSource, Holder.Reference<Structure> pStructure, BlockPos pPos) throws CommandSyntaxException {
        ...
        if (!structurestart.isValid()) {
            ...
            ChunkPos.rangeClosed(chunkpos, chunkpos1)
                .forEach(
                    p_313498_ -> structurestart.placeInChunk(
                            serverlevel,
        ...
        if (optional.isEmpty()) {
            ...
            if (pIntegrity < 1.0F) {
                structureplacesettings.clearProcessors()
                    ...
                    .setRandom(StructureBlockEntity.createRandom((long)pSeed));
            }
    ...
    private static void checkLoaded(ServerLevel pLevel, ChunkPos pStart, ChunkPos pEnd) throws CommandSyntaxException {
        if (ChunkPos.rangeClosed(pStart, pEnd).filter(p_313494_ -> !pLevel.isLoaded(p_313494_.getWorldPosition())).findAny().isPresent()) {
