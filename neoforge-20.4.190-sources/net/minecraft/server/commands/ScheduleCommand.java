            ...
            pFunction.getSecond()
                .ifLeft(
                    p_305875_ -> {
                        ...
                        pSource.sendSuccess(
                            () -> Component.translatable("commands.schedule.created.function", Component.translationArg(resourcelocation), pTime, i), true
                        );
                    }
                )
                .ifRight(
                    p_288548_ -> {
                        ...
                        pSource.sendSuccess(
                            () -> Component.translatable("commands.schedule.created.tag", Component.translationArg(resourcelocation), pTime, i), true
                        );
                    }
                );
