...
public final class Graph {
     ...
     *
     * @param pNonCyclicalNodes       Nodes that are verified to have no cycles
     *                                involving them.
     * @param pPathSet                The current collection of seen nodes. When
     *                                invoked not recursively, this should be an empty
     *                                set.
     * @param pOnNonCyclicalNodeFound Invoked on each node as we prove that no cycles
