...
public class JfrProfiler implements JvmProfiler {
    ...
    @Override
    public void onPacketReceived(ConnectionProtocol pProtocol, int pPacketId, SocketAddress pRemoteAddress, int pBytes) {
        if (PacketReceivedEvent.TYPE.isEnabled()) {
            new PacketReceivedEvent(pProtocol.id(), pPacketId, pRemoteAddress, pBytes).commit();
        }
    ...
    @Override
    public void onPacketSent(ConnectionProtocol pProtocol, int pPacketId, SocketAddress pRemoteAddress, int pBytes) {
        if (PacketSentEvent.TYPE.isEnabled()) {
            new PacketSentEvent(pProtocol.id(), pPacketId, pRemoteAddress, pBytes).commit();
        }
