...
public class StringDecomposer {
     ...
     * @param pDefaultStyle The default style for the sequence that should be applied
    ...
    public static boolean iterateFormatted(FormattedText pText, Style pStyle, FormattedCharSink pSink) {
        return pText.visit((p_14302_, p_14303_) -> iterateFormatted(p_14303_, 0, p_14302_, pSink) ? Optional.empty() : STOP_ITERATION, pStyle)
            .isEmpty();
    }
