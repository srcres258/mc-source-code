    ...
    public final TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped(
            ...
            p_216688_ -> {
                ...
                return optional.isPresent() && this.idFilter.test(optional.get().getSecond())
                    ? p_216688_.updateTyped(opticfinder1, p_216690_ -> p_216690_.update(DSL.remainderFinder(), this::fixItemStackTag))
                    : p_216688_;
            }
        );
    }
