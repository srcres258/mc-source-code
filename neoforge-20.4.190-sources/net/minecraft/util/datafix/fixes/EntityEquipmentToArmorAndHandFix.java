...
public class EntityEquipmentToArmorAndHandFix extends DataFix {
    ...
    private <IS> TypeRewriteRule cap(Type<IS> pItemStackType) {
        ...
        Type<Pair<Either<List<IS>, Unit>, Pair<Either<List<IS>, Unit>, Dynamic<?>>>> type1 = DSL.and(
            DSL.optional(DSL.field("ArmorItems", DSL.list(pItemStackType))), DSL.optional(DSL.field("HandItems", DSL.list(pItemStackType))), DSL.remainderType()
        );
        ...
        return this.fixTypeEverywhereTyped(
            ...
            p_15425_ -> {
                ...
                if (optional.isPresent()) {
                    ...
                    IS is = (IS)((Pair)pItemStackType.read(dynamic.emptyMap())
                            .result()
                ...
                if (optional1.isPresent()) {
                    Iterator<? extends Dynamic<?>> iterator = Stream.concat(optional1.get(), Stream.generate(() -> dynamic2.createInt(0))).iterator();
