                    ...
                    p_185010_ -> {
                        p_185010_ = p_185010_.update(
                            ...
                            p_185078_ -> DataFixUtils.orElse(
                                    p_185078_.get("LiquidTicks").result().map(p_185072_ -> p_185078_.set("fluid_ticks", p_185072_).remove("LiquidTicks")),
                                    p_185078_
                                )
                        );
    ...
    private Dynamic<?> makeTickList(
        ...
        for(int i = 0; i < list.size(); ++i) {
            ...
            Stream<? extends Dynamic<?>> stream1 = list.get(i)
                ...
                .mapToObj(p_185059_ -> this.createTick(pDynamic, supplier, pX, j, pZ, p_185059_, p_185043_));
    ...
    private static String getLiquid(@Nullable Dynamic<?> p_185069_) {
        if (p_185069_ == null) {
            ...
            if ("minecraft:water".equals(s)) {
                ...
                return !ALWAYS_WATERLOGGED.contains(s) && !p_185069_.get("Properties").get("waterlogged").asBoolean(false)
                    ? "minecraft:empty"
                    : "minecraft:water";
            }
        }
    ...
    private Dynamic<?> createTick(
        ...
        return pDynamic.createMap(
            ImmutableMap.<Dynamic<?>, Dynamic<?>>builder()
                .put(pDynamic.createString("i"), pDynamic.createString(s))
                .put(pDynamic.createString("x"), pDynamic.createInt(pX * 16 + i))
                .put(pDynamic.createString("y"), pDynamic.createInt(pY * 16 + j))
                .put(pDynamic.createString("z"), pDynamic.createInt(pZ * 16 + k))
                .put(pDynamic.createString("t"), pDynamic.createInt(0))
                .put(pDynamic.createString("p"), pDynamic.createInt(0))
                .build()
        );
    }
