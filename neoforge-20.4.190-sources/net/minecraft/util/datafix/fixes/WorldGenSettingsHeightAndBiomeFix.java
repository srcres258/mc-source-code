...
public class WorldGenSettingsHeightAndBiomeFix extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped(
            ...
            type1,
            p_311573_ -> {
                OptionalDynamic<?> optionaldynamic = p_311573_.get(DSL.remainderFinder()).get("has_increased_height_already");
                boolean flag = optionaldynamic.result().isEmpty();
                boolean flag1 = optionaldynamic.asBoolean(true);
                return p_311573_.update(DSL.remainderFinder(), p_185205_ -> p_185205_.remove("has_increased_height_already"))
                    .updateTyped(
                        opticfinder,
                        type2,
                        p_311577_ -> Util.writeAndReadTypedOrThrow(
                                p_311577_,
                                type2,
                                p_311580_ -> p_311580_.update(
                                        "minecraft:overworld",
