...
public class WorldGenSettingsFix extends DataFix {
    ...
    private static <T> Dynamic<T> noise(long pSeed, DynamicLike<T> pDynamic, Dynamic<T> pSettings, Dynamic<T> pBiomeNoise) {
        return pDynamic.createMap(
            ImmutableMap.of(
                pDynamic.createString("type"),
                pDynamic.createString("minecraft:noise"),
                pDynamic.createString("biome_source"),
                pBiomeNoise,
                pDynamic.createString("seed"),
                pDynamic.createLong(pSeed),
                pDynamic.createString("settings"),
                pSettings
            )
        );
    }
    ...
    private static <T> Dynamic<T> vanillaBiomeSource(Dynamic<T> pDynamic, long pSeed, boolean pLegacyBiomeInitLayer, boolean pLargeBiomes) {
        Builder<Dynamic<T>, Dynamic<T>> builder = ImmutableMap.<Dynamic<T>, Dynamic<T>>builder()
            .put(pDynamic.createString("type"), pDynamic.createString("minecraft:vanilla_layered"))
            .put(pDynamic.createString("seed"), pDynamic.createLong(pSeed))
            .put(pDynamic.createString("large_biomes"), pDynamic.createBoolean(pLargeBiomes));
            ...
            switch($$28) {
                ...
                case "buffet":
                    ...
                    if (dynamic2.get("type").asString().result().equals(Optional.of("minecraft:fixed"))) {
                        String s1 = dynamic2.get("options")
                            ...
                            .asStream()
                            .findFirst()
                            .flatMap(p_17259_ -> p_17259_.asString().result())
                ...
                default:
                    ...
                    dynamic = noise(
                        i,
                        p_17186_,
                        p_17186_.createString(flag2 ? "minecraft:amplified" : "minecraft:overworld"),
                        vanillaBiomeSource(p_17186_, i, flag1, flag3)
                    );
            }
        }
                ...
                dynamicops.createMap(
                    ImmutableMap.of(
                        ...
                        noise(
                                pSeed,
                                pDynamic,
                                pDynamic.createString("minecraft:nether"),
                                pDynamic.createMap(
                                    ImmutableMap.of(
                                        pDynamic.createString("type"),
                                        pDynamic.createString("minecraft:multi_noise"),
                                        pDynamic.createString("seed"),
                                        pDynamic.createLong(pSeed),
                                        pDynamic.createString("preset"),
                                        pDynamic.createString("minecraft:nether")
                                    )
                                )
                            )
                ...
                dynamicops.createMap(
                    ImmutableMap.of(
                        ...
                        noise(
                                pSeed,
                                pDynamic,
                                pDynamic.createString("minecraft:end"),
                                pDynamic.createMap(
                                    ImmutableMap.of(
                                        pDynamic.createString("type"),
                                        pDynamic.createString("minecraft:the_end"),
                                        pDynamic.createString("seed"),
                                        pDynamic.createLong(pSeed)
                                    )
                                )
        ...
        p_17219_.get("structures")
            ...
            .ifPresent(
                p_17257_ -> p_17257_.forEach(
                        (p_145823_, p_145824_) -> p_145824_.getMapValues()
                                .result()
                                .ifPresent(
        ...
        builder.put(
            ...
            p_17219_.createMap(
                map.entrySet()
                    ...
                    .collect(
                        Collectors.toMap(
                            p_17225_ -> p_17219_.createString((String)p_17225_.getKey()),
                            p_17222_ -> ((WorldGenSettingsFix.StructureFeatureConfiguration)p_17222_.getValue()).serialize(pOps)
                        )
                    )
            )
        );
