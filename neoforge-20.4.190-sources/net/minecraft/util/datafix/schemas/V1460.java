...
public class V1460 extends NamespacedSchema {
    ...
    public Map<String, Supplier<TypeTemplate>> registerEntities(Schema pSchema) {
        ...
        pSchema.register(map, "minecraft:commandblock_minecart", p_17677_ -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(pSchema)));
    ...
    public void registerTypes(Schema pSchema, Map<String, Supplier<TypeTemplate>> pEntityTypes, Map<String, Supplier<TypeTemplate>> pBlockEntityTypes) {
        ...
        pSchema.registerType(true, References.BLOCK_ENTITY, () -> DSL.taggedChoiceLazy("id", namespacedString(), pBlockEntityTypes));
        pSchema.registerType(
        ...
        pSchema.registerType(
            ...
            () -> DSL.optionalFields(
                    ...
                    DSL.optionalFields(
                        "minecraft:mined",
                        DSL.compoundList(References.BLOCK_NAME.in(pSchema), DSL.constType(DSL.intType())),
                        "minecraft:crafted",
                        supplier.get(),
                        "minecraft:used",
                        supplier.get(),
                        ...
                        DSL.optionalFields(
                            ...
                            supplier.get(),
                            "minecraft:killed",
                            DSL.compoundList(References.ENTITY_NAME.in(pSchema), DSL.constType(DSL.intType())),
                            "minecraft:killed_by",
                            DSL.compoundList(References.ENTITY_NAME.in(pSchema), DSL.constType(DSL.intType())),
                            "minecraft:custom",
