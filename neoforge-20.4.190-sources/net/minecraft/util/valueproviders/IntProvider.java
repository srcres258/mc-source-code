...
public abstract class IntProvider {
    ...
    public static final Codec<IntProvider> CODEC = CONSTANT_OR_DISPATCH_CODEC.xmap(
        p_146543_ -> p_146543_.map(ConstantInt::of, p_146549_ -> p_146549_),
        ...
        return ExtraCodecs.validate(
            ...
            p_274951_ -> {
                if (p_274951_.getMinValue() < pMinInclusive) {
                    return DataResult.error(() -> "Value provider too low: " + pMinInclusive + " [" + p_274951_.getMinValue() + "-" + p_274951_.getMaxValue() + "]");
                } else {
                    return p_274951_.getMaxValue() > pMaxInclusive
                        ? DataResult.error(() -> "Value provider too high: " + pMaxInclusive + " [" + p_274951_.getMinValue() + "-" + p_274951_.getMaxValue() + "]")
