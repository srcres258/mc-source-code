...
public class Mth {
     ...
     * @param pDelta A value between 0 and 1 that indicates the percentage of the lerp
     ...
     * Method for linear interpolation of floats
     *
     * @param pDelta A value usually between 0 and 1 that indicates the percentage of
    ...
    public static double lerp3(
        ...
        return lerp(
            pDelta3, lerp2(pDelta1, pDelta2, pStart1, pEnd1, pStart2, pEnd2), lerp2(pDelta1, pDelta2, pStart3, pEnd3, pStart4, pEnd4)
        );
    }
