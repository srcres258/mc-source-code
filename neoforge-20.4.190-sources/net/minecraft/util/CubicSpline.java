...
public interface CubicSpline<C, I extends ToFloatFunction<C>> extends ToFloatFunction<C> {
    ...
    static <C, I extends ToFloatFunction<C>> Codec<CubicSpline<C, I>> codec(Codec<I> p_184263_) {
        ...
        Codec<Point<C, I>> codec = RecordCodecBuilder.create(
            p_184270_ -> p_184270_.group(
                    ...
                    .apply(p_184270_, (p_184242_, p_184243_, p_184244_) -> new Point<>(p_184242_, p_184243_, p_184244_))
        );
                        ...
                        ExtraCodecs.nonEmptyList(codec.listOf())
                            ...
                            .forGetter(
                                p_184272_ -> IntStream.range(0, p_184272_.locations.length)
                                        .mapToObj(
                                            p_184249_ -> new Point<>(
                                                    p_184272_.locations()[p_184249_],
                                                    (CubicSpline<C, I>)p_184272_.values().get(p_184249_),
                                                    p_184272_.derivatives()[p_184249_]
                                                )
                                        )
                                        .toList()
                            )
        ...
        mutableobject.setValue(
            Codec.either(Codec.FLOAT, codec1)
                .xmap(
                    ...
                    p_184251_ -> p_184251_ instanceof CubicSpline.Constant constant
    ...
    public static record Multipoint<C, I extends ToFloatFunction<C>>(
        ...
        private String toString(float[] pLocations) {
            return "["
                + (String)IntStream.range(0, pLocations.length)
        ...
        public CubicSpline<C, I> mapAll(CubicSpline.CoordinateVisitor<I> pVisitor) {
            return create(
                pVisitor.visit(this.coordinate),
                this.locations,
                this.values().stream().map(p_211588_ -> p_211588_.mapAll(pVisitor)).toList(),
                this.derivatives
            );
        }
    }
