...
public class SpawnPlacements {
    ...
    @Deprecated // FORGE: use SpawnPlacementRegisterEvent to register and modify spawn placements
        EntityType<T> pEntityType, SpawnPlacements.Type pDecoratorType, Heightmap.Types pHeightMapType, SpawnPlacements.SpawnPredicate<T> pDecoratorPredicate
    ) {
    ...
    static {
        ...
        register(
            EntityType.PUFFERFISH, SpawnPlacements.Type.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, WaterAnimal::checkSurfaceWaterAnimalSpawnRules
        );
