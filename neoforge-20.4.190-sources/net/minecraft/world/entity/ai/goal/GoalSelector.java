...
public class GoalSelector {
    ...
    public void removeGoal(Goal pGoal) {
        this.availableGoals.stream().filter(p_25378_ -> p_25378_.getGoal() == pGoal).filter(WrappedGoal::isRunning).forEach(WrappedGoal::stop);
        this.availableGoals.removeIf(p_25367_ -> p_25367_.getGoal() == pGoal);
    }
