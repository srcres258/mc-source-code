...
public class DefaultAttributes {
    ...
    public static AttributeSupplier getSupplier(EntityType<? extends LivingEntity> pLivingEntity) {
        AttributeSupplier supplier = net.neoforged.neoforge.common.CommonHooks.getAttributesView().get(pLivingEntity);
        return supplier != null ? supplier : SUPPLIERS.get(pLivingEntity);
    }

    public static boolean hasSupplier(EntityType<?> pEntityType) {
        return SUPPLIERS.containsKey(pEntityType) || net.neoforged.neoforge.common.CommonHooks.getAttributesView().containsKey(pEntityType);
    }
    ...
    public static void validate() {
        BuiltInRegistries.ENTITY_TYPE
            ...
            .filter(p_22304_ -> !hasSupplier(p_22304_))
            .map(BuiltInRegistries.ENTITY_TYPE::getKey)
            .forEach(p_22300_ -> Util.logAndPauseIfInIde("Entity " + p_22300_ + " has no attributes"));
    }
}
