...
public class SetEntityLookTargetSometimes {
    ...
    public static BehaviorControl<LivingEntity> create(EntityType<?> pEntityType, float pMaxDist, UniformInt pInterval) {
        return create(pMaxDist, pInterval, p_308654_ -> pEntityType.equals(p_308654_.getType()));
    }
    ...
    private static BehaviorControl<LivingEntity> create(float pMaxDist, UniformInt pInterval, Predicate<LivingEntity> pCanLookAtTarget) {
        ...
        return BehaviorBuilder.create(
            p_259288_ -> p_259288_.group(
                        p_259288_.absent(MemoryModuleType.LOOK_TARGET), p_259288_.present(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES)
                    )
                    .apply(
                        p_259288_,
                        (p_259350_, p_260134_) -> (p_264952_, p_264953_, p_264954_) -> {
                                Optional<LivingEntity> optional = p_259288_.<NearestVisibleLivingEntities>get(p_260134_)
                                    .findClosest(pCanLookAtTarget.and(p_259358_ -> p_259358_.distanceToSqr(p_264953_) <= (double)f));
                                if (optional.isEmpty()) {
                                    return false;
