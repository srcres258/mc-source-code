...
public class InteractWith {
    ...
    public static <E extends LivingEntity, T extends LivingEntity> BehaviorControl<E> of(
        ...
        Predicate<LivingEntity> predicate = p_308599_ -> pType.equals(p_308599_.getType()) && pTargetFilter.test((T)p_308599_);
                        ...
                        (p_258439_, p_258440_, p_258441_, p_258442_) -> (p_258413_, p_258414_, p_258415_) -> {
                                ...
                                if (pSelfFilter.test(p_258414_) && nearestvisiblelivingentities.contains(predicate)) {
                                    Optional<LivingEntity> optional = nearestvisiblelivingentities.findClosest(
                                        p_258419_ -> p_258419_.distanceToSqr(p_258414_) <= (double)i && predicate.test(p_258419_)
                                    );
