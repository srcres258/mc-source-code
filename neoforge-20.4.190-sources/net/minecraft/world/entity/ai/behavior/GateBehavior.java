...
public class GateBehavior<E extends LivingEntity> implements BehaviorControl<E> {
    ...
    public GateBehavior(
        ...
        pDurations.forEach(p_258332_ -> this.behaviors.add(p_258332_.getFirst(), p_258332_.getSecond()));
    }
    ...
    public final void tickOrStop(ServerLevel pLevel, E pEntity, long pGameTime) {
        this.behaviors
            ...
            .forEach(p_258336_ -> p_258336_.tickOrStop(pLevel, pEntity, pGameTime));
    ...
    public final void doStop(ServerLevel pLevel, E pEntity, long pGameTime) {
        ...
        this.behaviors
            ...
            .forEach(p_258341_ -> p_258341_.doStop(pLevel, pEntity, pGameTime));
