...
public class MoveToTargetSink extends Behavior<Mob> {
    ...
    protected void tick(ServerLevel pLevel, Mob pOwner, long pGameTime) {
        ...
        if (path != null && this.lastTargetPos != null) {
            ...
            if (walktarget.getTarget().currentBlockPosition().distSqr(this.lastTargetPos) > 4.0
                && this.tryComputePath(pOwner, walktarget, pLevel.getGameTime())) {
                this.lastTargetPos = walktarget.getTarget().currentBlockPosition();
    ...
    private static boolean isWalkTargetSpectator(WalkTarget p_277420_) {
        ...
        return positiontracker instanceof EntityTracker entitytracker ? entitytracker.getEntity().isSpectator() : false;
    }
}
