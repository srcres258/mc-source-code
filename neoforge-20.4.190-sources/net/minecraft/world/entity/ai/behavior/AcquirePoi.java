...
public class AcquirePoi {
    ...
    public static BehaviorControl<PathfinderMob> create(
        ...
        OneShot<PathfinderMob> oneshot = BehaviorBuilder.create(
            p_258276_ -> p_258276_.group(p_258276_.absent(pAcquiringMemory))
                    .apply(
                        p_258276_,
                        p_258300_ -> (p_258292_, p_258293_, p_258294_) -> {
                                if (pOnlyIfAdult && p_258293_.isBaby()) {
                                    ...
                                    Set<Pair<Holder<PoiType>, BlockPos>> set = poimanager.findAllClosestFirstWithType(
                                            pAcquirablePois, predicate, p_258293_.blockPosition(), 48, PoiManager.Occupancy.HAS_SPACE
                                        )
                                        .limit(5L)
                                    ...
                                    if (path != null && path.canReach()) {
                                        ...
                                        poimanager.getType(blockpos).ifPresent(p_313602_ -> {
                                            ...
                                            pEntityEventId.ifPresent(p_147369_ -> p_258292_.broadcastEntityEvent(p_258293_, p_147369_));
