...
public class StopAttackingIfTargetInvalid {
    ...
    public static <E extends Mob> BehaviorControl<E> create(BiConsumer<E, LivingEntity> pOnStopAttacking) {
        return create(p_147988_ -> false, pOnStopAttacking, true);
    }
                    ...
                    .apply(
                        ...
                        (p_258787_, p_258788_) -> (p_258795_, p_258796_, p_258797_) -> {
                                ...
                                if (p_258796_.canAttack(livingentity)
                                    && (!pCanGrowTiredOfTryingToReachTarget || !isTiredOfTryingToReachTarget(p_258796_, p_258801_.tryGet(p_258788_)))
                                    && livingentity.isAlive()
                                    && livingentity.level() == p_258796_.level()
                                    && !pCanStopAttacking.test(livingentity)) {
                                    return true;
                                } else {
