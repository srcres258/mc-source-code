...
public class CrossbowAttack<E extends Mob & CrossbowAttackMob, T extends LivingEntity> extends Behavior<E> {
    ...
    protected boolean checkExtraStartConditions(ServerLevel pLevel, E pOwner) {
        ...
        return pOwner.isHolding(is -> is.getItem() instanceof CrossbowItem)
            && BehaviorUtils.canSee(pOwner, livingentity)
            && BehaviorUtils.isWithinAttackRange(pOwner, livingentity, 0);
    }
