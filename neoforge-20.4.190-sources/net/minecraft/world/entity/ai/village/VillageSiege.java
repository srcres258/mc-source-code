                ...
                if (pLevel.isVillage(blockpos) && !pLevel.getBiome(blockpos).is(BiomeTags.WITHOUT_ZOMBIE_SIEGES)) {
                    for(int i = 0; i < 10; ++i) {
                        ...
                        if (siegeLocation != null) {
                            if (net.neoforged.neoforge.common.NeoForge.EVENT_BUS.post(new net.neoforged.neoforge.event.village.VillageSiegeEvent(this, pLevel, player, siegeLocation)).isCanceled()) return false;
