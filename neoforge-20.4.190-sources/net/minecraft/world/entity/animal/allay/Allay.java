...
public class Allay extends PathfinderMob implements InventoryCarrier, VibrationSystem {
    ...
    public boolean wantsToPickUp(ItemStack pStack) {
        ...
        return !itemstack.isEmpty()
            && this.inventory.canAddItem(pStack)
            && this.allayConsidersItemEqual(itemstack, pStack)
    ...
    class VibrationUser implements VibrationSystem.User {
        ...
        public void onReceiveVibration(
            ServerLevel p_281422_, BlockPos p_281449_, GameEvent p_281488_, @Nullable Entity p_281794_, @Nullable Entity p_281864_, float p_281642_
        ) {
