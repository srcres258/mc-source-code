...
public class Panda extends Animal {
    ...
    static final Predicate<ItemEntity> PANDA_ITEMS = p_308734_ -> {
        ItemStack itemstack = p_308734_.getItem();
        return (itemstack.is(Blocks.BAMBOO.asItem()) || itemstack.is(Blocks.CAKE.asItem())) && p_308734_.isAlive() && !p_308734_.hasPickUpDelay();
    };
    ...
    protected Vector3f getPassengerAttachmentPoint(Entity pEntity, EntityDimensions pDimensions, float pScale) {
        return new Vector3f(0.0F, pDimensions.height - (this.isBaby() ? 0.4375F : 0.0F) * pScale, 0.0F);
    }
