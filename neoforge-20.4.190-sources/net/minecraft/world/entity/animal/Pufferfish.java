...
public class Pufferfish extends AbstractFish {
    ...
    int inflateCounter;
    int deflateTimer;
    private static final Predicate<LivingEntity> SCARY_MOB = p_308735_ -> {
        if (p_308735_ instanceof Player && ((Player)p_308735_).isCreative()) {
            return false;
        } else {
            return p_308735_.getType() == EntityType.AXOLOTL || p_308735_.getMobType() != MobType.WATER;
        }
    };
