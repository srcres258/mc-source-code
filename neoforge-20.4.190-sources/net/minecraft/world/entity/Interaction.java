...
public class Interaction extends Entity implements Attackable, Targeting {
    ...
    protected void readAdditionalSaveData(CompoundTag pCompound) {
        ...
        if (pCompound.contains("attack")) {
            Interaction.PlayerAction.CODEC
                .decode(NbtOps.INSTANCE, pCompound.get("attack"))
        ...
        if (pCompound.contains("interaction")) {
            Interaction.PlayerAction.CODEC
                .decode(NbtOps.INSTANCE, pCompound.get("interaction"))
                .resultOrPartial(Util.prefix("Interaction entity", LOGGER::error))
    ...
    protected void addAdditionalSaveData(CompoundTag pCompound) {
        ...
        if (this.attack != null) {
            Interaction.PlayerAction.CODEC.encodeStart(NbtOps.INSTANCE, this.attack).result().ifPresent(p_272806_ -> pCompound.put("attack", p_272806_));
        }
        ...
        if (this.interaction != null) {
            Interaction.PlayerAction.CODEC
                ...
                .result()
                .ifPresent(p_272925_ -> pCompound.put("interaction", p_272925_));
        }
