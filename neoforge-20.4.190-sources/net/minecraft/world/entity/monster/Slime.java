...
public class Slime extends Mob implements Enemy {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector
            .addGoal(1, new NearestAttackableTargetGoal<>(this, Player.class, 10, true, false, p_311683_ -> Math.abs(p_311683_.getY() - this.getY()) <= 4.0));
    ...
    protected Vector3f getPassengerAttachmentPoint(Entity pEntity, EntityDimensions pDimensions, float pScale) {
        return new Vector3f(0.0F, pDimensions.height - 0.015625F * (float)this.getSize() * pScale, 0.0F);
    }
    ...
    public static boolean checkSlimeSpawnRules(
        EntityType<Slime> pSlime, LevelAccessor pLevel, MobSpawnType pSpawnType, BlockPos pPos, RandomSource pRandom
    ) {
