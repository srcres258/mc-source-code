...
public record ProfilePublicKey(ProfilePublicKey.Data data) {
    ...
    public static record Data(Instant expiresAt, PublicKey key, byte[] keySignature) {
        ...
        public boolean equals(Object pOther) {
            if (!(pOther instanceof ProfilePublicKey.Data)) {
                return false;
            } else {
                ProfilePublicKey.Data profilepublickey$data = (ProfilePublicKey.Data)pOther;
                return this.expiresAt.equals(profilepublickey$data.expiresAt)
