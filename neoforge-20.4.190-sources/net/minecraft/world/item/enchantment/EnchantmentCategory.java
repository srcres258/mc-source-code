...
public enum EnchantmentCategory implements net.neoforged.neoforge.common.IExtensibleEnum {
    ...
    ARMOR_FEET {
        ...
        public boolean canEnchant(Item p_44806_) {
            if (p_44806_ instanceof ArmorItem armoritem && armoritem.getEquipmentSlot() == EquipmentSlot.FEET) {
                return true;
            }
    ...
    ARMOR_LEGS {
        ...
        public boolean canEnchant(Item p_44811_) {
            if (p_44811_ instanceof ArmorItem armoritem && armoritem.getEquipmentSlot() == EquipmentSlot.LEGS) {
                return true;
            }
    ...
    ARMOR_CHEST {
        ...
        public boolean canEnchant(Item p_44816_) {
            if (p_44816_ instanceof ArmorItem armoritem && armoritem.getEquipmentSlot() == EquipmentSlot.CHEST) {
                return true;
            }
    ...
    ARMOR_HEAD {
        ...
        public boolean canEnchant(Item p_44756_) {
            if (p_44756_ instanceof ArmorItem armoritem && armoritem.getEquipmentSlot() == EquipmentSlot.HEAD) {
                return true;
            }
