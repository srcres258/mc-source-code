...
public class BottleItem extends Item {
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pHand) {
        List<AreaEffectCloud> list = pLevel.getEntitiesOfClass(
            ...
            p_308790_ -> p_308790_ != null && p_308790_.isAlive() && p_308790_.getOwner() instanceof EnderDragon
        );
        ...
        if (!list.isEmpty()) {
            ...
            return InteractionResultHolder.sidedSuccess(
                this.turnBottleIntoItem(itemstack, pPlayer, new ItemStack(Items.DRAGON_BREATH)), pLevel.isClientSide()
            );
        } else {
            ...
            if (blockhitresult.getType() == HitResult.Type.MISS) {
                ...
                if (blockhitresult.getType() == HitResult.Type.BLOCK) {
                    ...
                    if (pLevel.getFluidState(blockpos).is(FluidTags.WATER)) {
                        ...
                        return InteractionResultHolder.sidedSuccess(
                            this.turnBottleIntoItem(itemstack, pPlayer, PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.WATER)),
                            pLevel.isClientSide()
                        );
                    }
                }
