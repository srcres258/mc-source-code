                    ...
                    holder.unwrapKey()
                        ...
                        .ifPresent(
                            p_220006_ -> {
                                ...
                                pTooltipComponents.add(Component.translatable("block." + fileLoc.getNamespace() + ".banner." + fileLoc.getPath() + "." + dyecolor.getSerializedName()).withStyle(ChatFormatting.GRAY));
                            }
                        );
                }
            }
