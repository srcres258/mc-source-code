...
public class InstrumentItem extends Item {
    ...
    public static void setRandom(ItemStack pStack, TagKey<Instrument> pInstrumentTag, RandomSource pRandom) {
        Optional<Holder<Instrument>> optional = BuiltInRegistries.INSTRUMENT.getTag(pInstrumentTag).flatMap(p_220103_ -> p_220103_.getRandomElement(pRandom));
        optional.ifPresent(p_248417_ -> setSoundVariantId(pStack, p_248417_));
    }
