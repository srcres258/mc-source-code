...
public class Potion {
    ...
    /**
     * Attempts to find a {@code Potion} using a name. The name will be parsed as a namespaced identifier which will be used to look up the potion in the potion registry.
     * @return The potion that was found in the registry.
     *
     * @param pName The name of the potion to search for. This name will be parsed as
    ...
    /**
     * Gets the prefixed potion name. This is often used to create a localization key for items like the tipped arrows or bottled potion.
