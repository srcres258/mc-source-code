...
public class AnvilMenu extends ItemCombinerMenu {
    ...
    protected void onTake(Player pPlayer, ItemStack pStack) {
        ...
        float breakChance = net.neoforged.neoforge.common.CommonHooks.onAnvilRepair(pPlayer, pStack, AnvilMenu.this.inputSlots.getItem(0), AnvilMenu.this.inputSlots.getItem(1));
