...
public abstract class ItemCombinerMenu extends AbstractContainerMenu {
        ...
        return this.access
            .evaluate(
                (p_39785_, p_39786_) -> !this.isValidBlock(p_39785_.getBlockState(p_39786_))
                        ? false
                        : pPlayer.distanceToSqr((double)p_39786_.getX() + 0.5, (double)p_39786_.getY() + 0.5, (double)p_39786_.getZ() + 0.5) <= 64.0,
                true
            );
    }
    ...
    public ItemStack quickMoveStack(Player pPlayer, int pIndex) {
        ...
        if (slot != null && slot.hasItem()) {
            ...
            } else if (pIndex >= this.getUseRowStart()
                && pIndex < this.getUseRowEnd()
