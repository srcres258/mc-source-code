...
public class GrindstoneMenu extends AbstractContainerMenu {
    ...
    public GrindstoneMenu(int pContainerId, Inventory pPlayerInventory, final ContainerLevelAccess pAccess) {
        ...
        this.addSlot(new Slot(this.resultSlots, 2, 129, 34) {
            ...
            public void onTake(Player p_150574_, ItemStack p_150575_) {
                if (net.neoforged.neoforge.common.CommonHooks.onGrindstoneTake(GrindstoneMenu.this.repairSlots, pAccess, this::getExperienceAmount)) return;
    ...
    private void createResult() {
        ...
        if (!flag) {
            ...
            boolean flag2 = !itemstack.isEmpty() && !itemstack.is(Items.ENCHANTED_BOOK) && !itemstack.isEnchanted()
                || !itemstack1.isEmpty() && !itemstack1.is(Items.ENCHANTED_BOOK) && !itemstack1.isEnchanted();
    ...
    /**
     * Removes all enchantments from the {@linkplain net.minecraft.world.item.ItemStack}. Note that the curses are not removed.
     */
    private ItemStack removeNonCurses(ItemStack pStack, int pDamage, int pCount) {
        ...
        Map<Enchantment, Integer> map = EnchantmentHelper.getEnchantments(pStack)
            .entrySet()
            .stream()
            .filter(p_39584_ -> p_39584_.getKey().isCurse())
