...
public class PalettedContainer<T> implements PaletteResize<T>, PalettedContainerRO<T> {
    ...
    public static <T> Codec<PalettedContainerRO<T>> codecRO(IdMap<T> pRegistry, Codec<T> pCodec, PalettedContainer.Strategy pStrategy, T pValue) {
        PalettedContainerRO.Unpacker<T, PalettedContainerRO<T>> unpacker = (p_238265_, p_238266_, p_238267_) -> unpack(p_238265_, p_238266_, p_238267_)
                .map((Function<? super PalettedContainer<T>, ? extends PalettedContainer<T>>)(p_238264_ -> p_238264_));
        return codec(pRegistry, pCodec, pStrategy, pValue, unpacker);
    }
    ...
    private static <T, C extends PalettedContainerRO<T>> Codec<C> codec(
        ...
        return RecordCodecBuilder.<PalettedContainerRO.PackedData<T>>create(
                p_188047_ -> p_188047_.group(
                        ...
                        .apply(p_188047_, PalettedContainerRO.PackedData::new)
            )
            .comapFlatMap(p_238262_ -> pUnpacker.read(pRegistry, pStrategy, p_238262_), p_238263_ -> p_238263_.pack(pRegistry, pStrategy));
    }
