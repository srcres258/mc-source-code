...
public class GameEvent {
     ...
     *
     * @param pName The name of the event. This will be used to generate the
     *              namespaced identifier for the event.
     */
     ...
     * @return The newly registered game event.
     *
     * @param pName               The name of the event. This will be used to generate
     *                            the namespaced identifier for the event.
     * @param pNotificationRadius The radius around an event source to broadcast the
     *                            event. Any valid listeners within this radius will
     *                            be notified when the event happens.
     */
