...
public class BiomeGenerationSettings {
    ...
    public static class PlainBuilder {
        ...
        public BiomeGenerationSettings.PlainBuilder addCarver(GenerationStep.Carving pCarving, Holder<ConfiguredWorldCarver<?>> pCarver) {
            this.carvers.computeIfAbsent(pCarving, p_256199_ -> Lists.newArrayList()).add(pCarver);
            return this;
        }
        ...
        public BiomeGenerationSettings build() {
            return new BiomeGenerationSettings(
                this.carvers.entrySet().stream().collect(ImmutableMap.toImmutableMap(Entry::getKey, p_255831_ -> HolderSet.direct((List)p_255831_.getValue()))),
