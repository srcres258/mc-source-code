...
public final class OverworldBiomeBuilder {
    ...
    private void addDebugBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> pKey) {
        ...
        CubicSpline<?, ?> cubicspline1 = TerrainProvider.overworldOffset(
            densityfunctions$spline$coordinate, densityfunctions$spline$coordinate1, densityfunctions$spline$coordinate2, false
        );
    ...
    private void addOffCoastBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> pConsumer) {
        this.addSurfaceBiome(
            pConsumer, this.FULL_RANGE, this.FULL_RANGE, this.mushroomFieldsContinentalness, this.FULL_RANGE, this.FULL_RANGE, 0.0F, Biomes.MUSHROOM_FIELDS
        );

        for(int i = 0; i < this.temperatures.length; ++i) {
            Climate.Parameter climate$parameter = this.temperatures[i];
            this.addSurfaceBiome(
                pConsumer, climate$parameter, this.FULL_RANGE, this.deepOceanContinentalness, this.FULL_RANGE, this.FULL_RANGE, 0.0F, this.OCEANS[0][i]
            );
            this.addSurfaceBiome(
                pConsumer, climate$parameter, this.FULL_RANGE, this.oceanContinentalness, this.FULL_RANGE, this.FULL_RANGE, 0.0F, this.OCEANS[1][i]
            );
        }
    }
    ...
    private void addPeaks(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> pConsumer, Climate.Parameter pParam) {
        for(int i = 0; i < this.temperatures.length; ++i) {
            ...
            for(int j = 0; j < this.humidities.length; ++j) {
                ...
                this.addSurfaceBiome(
                    pConsumer, climate$parameter, climate$parameter1, this.midInlandContinentalness, this.erosions[3], pParam, 0.0F, resourcekey1
                );
                this.addSurfaceBiome(
                    pConsumer, climate$parameter, climate$parameter1, this.farInlandContinentalness, this.erosions[3], pParam, 0.0F, resourcekey3
                );
                this.addSurfaceBiome(
                    pConsumer,
                    climate$parameter,
    ...
    private void addHighSlice(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> pConsumer, Climate.Parameter pParam) {
        for(int i = 0; i < this.temperatures.length; ++i) {
            ...
            for(int j = 0; j < this.humidities.length; ++j) {
                ...
                this.addSurfaceBiome(
                    pConsumer, climate$parameter, climate$parameter1, this.nearInlandContinentalness, this.erosions[0], pParam, 0.0F, resourcekey6
                );
                this.addSurfaceBiome(
                    pConsumer,
                    climate$parameter,
                ...
                this.addSurfaceBiome(
                    pConsumer, climate$parameter, climate$parameter1, this.nearInlandContinentalness, this.erosions[1], pParam, 0.0F, resourcekey2
                );
                this.addSurfaceBiome(
                    pConsumer,
                    climate$parameter,
    ...
    private void addMidSlice(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> pConsumer, Climate.Parameter pParam) {
        ...
        for(int i = 0; i < this.temperatures.length; ++i) {
            ...
            for(int j = 0; j < this.humidities.length; ++j) {
                ...
                this.addSurfaceBiome(
                    pConsumer, climate$parameter, climate$parameter1, this.nearInlandContinentalness, this.erosions[2], pParam, 0.0F, resourcekey
                );
                this.addSurfaceBiome(
                    pConsumer, climate$parameter, climate$parameter1, this.midInlandContinentalness, this.erosions[2], pParam, 0.0F, resourcekey1
                );
                this.addSurfaceBiome(
                    pConsumer, climate$parameter, climate$parameter1, this.farInlandContinentalness, this.erosions[2], pParam, 0.0F, resourcekey4
                );
                this.addSurfaceBiome(
                    pConsumer,
                    climate$parameter,
                ...
                if (pParam.max() < 0L) {
                    this.addSurfaceBiome(
                        pConsumer, climate$parameter, climate$parameter1, this.coastContinentalness, this.erosions[4], pParam, 0.0F, resourcekey5
                    );
                    this.addSurfaceBiome(
                        pConsumer,
                        climate$parameter,
                ...
                this.addSurfaceBiome(
                    pConsumer, climate$parameter, climate$parameter1, this.coastContinentalness, this.erosions[5], pParam, 0.0F, resourcekey7
                );
                this.addSurfaceBiome(
                    pConsumer, climate$parameter, climate$parameter1, this.nearInlandContinentalness, this.erosions[5], pParam, 0.0F, resourcekey6
                );
                this.addSurfaceBiome(
                    pConsumer,
                    climate$parameter,
                ...
                if (pParam.max() < 0L) {
                    this.addSurfaceBiome(
                        pConsumer, climate$parameter, climate$parameter1, this.coastContinentalness, this.erosions[6], pParam, 0.0F, resourcekey5
                    );
                } else {
                    this.addSurfaceBiome(
                        pConsumer, climate$parameter, climate$parameter1, this.coastContinentalness, this.erosions[6], pParam, 0.0F, resourcekey
                    );
                }
    ...
    private void addLowSlice(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> pConsumer, Climate.Parameter pParam) {
        ...
        for(int i = 0; i < this.temperatures.length; ++i) {
            ...
            for(int j = 0; j < this.humidities.length; ++j) {
                ...
                this.addSurfaceBiome(
                    pConsumer, climate$parameter, climate$parameter1, this.coastContinentalness, this.erosions[5], pParam, 0.0F, resourcekey5
                );
                this.addSurfaceBiome(
                    pConsumer, climate$parameter, climate$parameter1, this.nearInlandContinentalness, this.erosions[5], pParam, 0.0F, resourcekey4
                );
                this.addSurfaceBiome(
                    pConsumer,
                    climate$parameter,
                ...
                this.addSurfaceBiome(
                    pConsumer, climate$parameter, climate$parameter1, this.coastContinentalness, this.erosions[6], pParam, 0.0F, resourcekey3
                );
                if (i == 0) {
                    this.addSurfaceBiome(
                        pConsumer,
    ...
    private ResourceKey<Biome> pickShatteredCoastBiome(int pTemperature, int pHumidity, Climate.Parameter pParam) {
        ResourceKey<Biome> resourcekey = pParam.max() >= 0L
            ? this.pickMiddleBiome(pTemperature, pHumidity, pParam)
            : this.pickBeachBiome(pTemperature, pHumidity);
