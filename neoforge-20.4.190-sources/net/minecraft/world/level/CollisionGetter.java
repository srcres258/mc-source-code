...
public interface CollisionGetter extends BlockGetter {
    ...
    default boolean isUnobstructed(BlockState pState, BlockPos pPos, CollisionContext pContext) {
        ...
        return voxelshape.isEmpty() || this.isUnobstructed(null, voxelshape.move((double)pPos.getX(), (double)pPos.getY(), (double)pPos.getZ()));
    }
    ...
    default Iterable<VoxelShape> getBlockCollisions(@Nullable Entity pEntity, AABB pCollisionBox) {
        return () -> new BlockCollisions<>(this, pEntity, pCollisionBox, false, (p_286215_, p_286216_) -> p_286216_);
    }
    ...
    default Optional<Vec3> findFreePosition(
        @Nullable Entity pEntity, VoxelShape pShape, Vec3 pPos, double pX, double pY, double pZ
    ) {
        if (pShape.isEmpty()) {
