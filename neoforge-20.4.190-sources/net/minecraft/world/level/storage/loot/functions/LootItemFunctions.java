...
public class LootItemFunctions {
    ...
    private static LootItemFunctionType register(String pId, Codec<? extends LootItemFunction> pCodec) {
        return Registry.register(BuiltInRegistries.LOOT_FUNCTION_TYPE, new ResourceLocation(pId), new LootItemFunctionType(pCodec));
    }
