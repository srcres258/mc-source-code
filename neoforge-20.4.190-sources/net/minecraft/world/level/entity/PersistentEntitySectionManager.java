...
public class PersistentEntitySectionManager<T extends EntityAccess> implements AutoCloseable {
    ...
    private boolean addEntity(T pEntity, boolean pWorldGenSpawned) {
        if (pEntity instanceof Entity entity && net.neoforged.neoforge.common.NeoForge.EVENT_BUS.post(new net.neoforged.neoforge.event.entity.EntityJoinLevelEvent(entity, entity.level(), pWorldGenSpawned)).isCanceled()) return false;
    ...
    class Callback implements EntityInLevelCallback {
        ...
        public void onRemove(Entity.RemovalReason pReason) {
            if (!this.currentSection.remove(this.entity)) {
                PersistentEntitySectionManager.LOGGER
                    .warn("Entity {} wasn't found in section {} (destroying due to {})", this.entity, SectionPos.of(this.currentSectionKey), pReason);
            }
