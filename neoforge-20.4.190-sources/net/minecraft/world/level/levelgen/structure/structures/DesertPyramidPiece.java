...
public class DesertPyramidPiece extends ScatteredFeaturePiece {
    ...
    public void postProcess(
        ...
        if (this.updateHeightPositionToLowestGroundHeight(pLevel, -pRandom.nextInt(3))) {
            ...
            this.generateBox(
                pLevel, pBox, this.width - 5, 0, 0, this.width - 1, 9, 4, Blocks.SANDSTONE.defaultBlockState(), Blocks.AIR.defaultBlockState(), false
            );
            this.generateBox(
                pLevel,
                pBox,
            ...
            this.generateBox(
                pLevel, pBox, 12, 1, 8, 12, 3, 8, Blocks.CUT_SANDSTONE.defaultBlockState(), Blocks.CUT_SANDSTONE.defaultBlockState(), false
            );
            this.generateBox(
                pLevel, pBox, 8, 1, 12, 8, 3, 12, Blocks.CUT_SANDSTONE.defaultBlockState(), Blocks.CUT_SANDSTONE.defaultBlockState(), false
            );
            this.generateBox(
                pLevel, pBox, 12, 1, 12, 12, 3, 12, Blocks.CUT_SANDSTONE.defaultBlockState(), Blocks.CUT_SANDSTONE.defaultBlockState(), false
            );
            ...
            this.generateBox(
                pLevel, pBox, this.width - 3, 4, 4, this.width - 3, 6, 4, Blocks.AIR.defaultBlockState(), Blocks.AIR.defaultBlockState(), false
            );
            ...
            this.generateBox(
                pLevel, pBox, this.width - 6, 1, 5, this.width - 5, 2, 16, Blocks.AIR.defaultBlockState(), Blocks.AIR.defaultBlockState(), false
            );
            ...
            this.generateBox(
                pLevel, pBox, 8, -14, 8, 12, -11, 12, Blocks.CUT_SANDSTONE.defaultBlockState(), Blocks.CUT_SANDSTONE.defaultBlockState(), false
            );
            this.generateBox(
                pLevel,
                pBox,
            ...
            this.generateBox(
                pLevel, pBox, 8, -9, 8, 12, -9, 12, Blocks.CUT_SANDSTONE.defaultBlockState(), Blocks.CUT_SANDSTONE.defaultBlockState(), false
            );
            ...
            for(Direction direction : Direction.Plane.HORIZONTAL) {
                if (!this.hasPlacedChest[direction.get2DDataValue()]) {
                    ...
                    this.hasPlacedChest[direction.get2DDataValue()] = this.createChest(
                        pLevel, pBox, pRandom, 10 + i1, -11, 10 + j1, BuiltInLootTables.DESERT_PYRAMID
                    );
                }
            }
