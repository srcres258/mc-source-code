...
public class WoodlandMansionPieces {
    ...
    static class MansionPiecePlacer {
                            ...
                            if (woodlandmansionpieces$simplegrid3.get(j1, i1 - 1) == 1
                                ...
                                pPieces.add(
                                    new WoodlandMansionPieces.WoodlandMansionPiece(
                                        ...
                                        "carpet_north",
                                        blockpos1.relative(pRotation.rotate(Direction.EAST), 1).above(),
                                        pRotation
                                    )
                                );
                            }
                    ...
                    for(int l1 = 0; l1 < woodlandmansionpieces$simplegrid3.width; ++l1) {
                        ...
                        if (woodlandmansionpieces$simplegrid3.get(l1, k1) == 2 || flag1) {
                            ...
                            if (WoodlandMansionPieces.MansionGrid.isHouse(woodlandmansionpieces$simplegrid3, l1 - 1, k1)
                                ...
                                pPieces.add(
                                    new WoodlandMansionPieces.WoodlandMansionPiece(
                                        this.structureTemplateManager, direction1 == Direction.WEST ? s3 : s2, blockpos3, pRotation
                                    )
                                );
                            }
                            ...
                            if (woodlandmansionpieces$simplegrid3.get(l1 + 1, k1) == 1 && !flag1) {
                                ...
                                pPieces.add(
                                    new WoodlandMansionPieces.WoodlandMansionPiece(
                                        this.structureTemplateManager, direction1 == Direction.EAST ? s3 : s2, blockpos2, pRotation
                                    )
                                );
                            }
                            ...
                            if (WoodlandMansionPieces.MansionGrid.isHouse(woodlandmansionpieces$simplegrid3, l1, k1 + 1)
                                ...
                                pPieces.add(
                                    new WoodlandMansionPieces.WoodlandMansionPiece(
                                        ...
                                        blockpos4,
                                        pRotation.getRotated(Rotation.CLOCKWISE_90)
                                    )
                                );
                            }
            ...
            do {
                if (!WoodlandMansionPieces.MansionGrid.isHouse(pLayout, i + pDirection.getStepX(), j + pDirection.getStepZ())) {
                    ...
                    && WoodlandMansionPieces.MansionGrid.isHouse(
                        pLayout,
                        i + pDirection.getStepX() + pDirection.getCounterClockWise().getStepX(),
                        j + pDirection.getStepZ() + pDirection.getCounterClockWise().getStepZ()
                    )) {
                        ...
                        if (WoodlandMansionPieces.MansionGrid.isHouse(pLayout, i1, k) && flag1) {
                            ...
                            if (!WoodlandMansionPieces.MansionGrid.isHouse(pLayout, i1 + 1, k)) {
                                if (!WoodlandMansionPieces.MansionGrid.isHouse(pLayout, i1, k - 1)) {
                                    ...
                                    pPieces.add(
                                        new WoodlandMansionPieces.WoodlandMansionPiece(
                                            this.structureTemplateManager, "small_wall_corner", blockpos12, pRotation
                                        )
                                    );
                                }
                    ...
                    if (WoodlandMansionPieces.MansionGrid.isHouse(pLayout, j1, l) && !flag2) {
                        if (!WoodlandMansionPieces.MansionGrid.isHouse(pLayout, j1 + 1, l)) {
                            ...
                            if (!WoodlandMansionPieces.MansionGrid.isHouse(pLayout, j1, l + 1)) {
                                ...
                                pPieces.add(
                                    new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, "roof_corner", blockpos2, pRotation)
                                );
                                ...
                                pPieces.add(
                                    new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, "roof_inner_corner", blockpos18, pRotation)
                                );
                            }
        ...
        private void entrance(List<WoodlandMansionPieces.WoodlandMansionPiece> pPieces, WoodlandMansionPieces.PlacementData pData) {
            ...
            pPieces.add(
                new WoodlandMansionPieces.WoodlandMansionPiece(
                    this.structureTemplateManager, "entrance", pData.position.relative(direction, 9), pData.rotation
                )
            );
        ...
        private void traverseWallPiece(List<WoodlandMansionPieces.WoodlandMansionPiece> pPieces, WoodlandMansionPieces.PlacementData pData) {
            pPieces.add(
                new WoodlandMansionPieces.WoodlandMansionPiece(
                    this.structureTemplateManager,
                    pData.wallType,
                    pData.position.relative(pData.rotation.rotate(Direction.EAST), 7),
                    pData.rotation
                )
            );
        ...
        private void addRoom1x2(
            ...
            if (pSideDirection == Direction.EAST && pFrontDirection == Direction.SOUTH) {
                ...
                pPieces.add(
                    new WoodlandMansionPieces.WoodlandMansionPiece(
                        this.structureTemplateManager, pFloorRooms.get1x2SideEntrance(this.random, pIsStairs), blockpos13, pRotation
                    )
                );
                ...
                pPieces.add(
                    new WoodlandMansionPieces.WoodlandMansionPiece(
                        this.structureTemplateManager,
                        pFloorRooms.get1x2SideEntrance(this.random, pIsStairs),
                        blockpos11,
                        pRotation.getRotated(Rotation.CLOCKWISE_180)
                    )
                );
                ...
                pPieces.add(
                    new WoodlandMansionPieces.WoodlandMansionPiece(
                        ...
                        pFloorRooms.get1x2SideEntrance(this.random, pIsStairs),
                        blockpos6,
                        pRotation.getRotated(Rotation.COUNTERCLOCKWISE_90)
                    )
                );
                ...
                pPieces.add(
                    new WoodlandMansionPieces.WoodlandMansionPiece(
                        this.structureTemplateManager, pFloorRooms.get1x2FrontEntrance(this.random, pIsStairs), blockpos5, pRotation
                    )
                );
                ...
                pPieces.add(
                    new WoodlandMansionPieces.WoodlandMansionPiece(
                        this.structureTemplateManager,
                        pFloorRooms.get1x2FrontEntrance(this.random, pIsStairs),
                        blockpos4,
                        pRotation.getRotated(Rotation.CLOCKWISE_180)
                    )
                );
                ...
                pPieces.add(
                    new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, pFloorRooms.get1x2Secret(this.random), blockpos, pRotation)
                );
            }
        }
        ...
        private void addRoom2x2(
            ...
            pPieces.add(
                new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, pFloorRooms.get2x2(this.random), blockpos, rotation, mirror)
            );
        }
        ...
        private void addRoom2x2Secret(
            ...
            pPieces.add(
                new WoodlandMansionPieces.WoodlandMansionPiece(
                    this.structureTemplateManager, pFloorRooms.get2x2Secret(this.random), blockpos, pRotation, Mirror.NONE
                )
            );
        }
    }
            ...
            if (pName.startsWith("Chest")) {
                ...
                for(Mob mob : list) {
                    if (mob != null) {
                        ...
                        mob.finalizeSpawn(pLevel, pLevel.getCurrentDifficultyAt(mob.blockPosition()), MobSpawnType.STRUCTURE, null, null);
