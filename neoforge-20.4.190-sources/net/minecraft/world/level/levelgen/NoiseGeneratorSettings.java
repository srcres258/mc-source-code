...
public record NoiseGeneratorSettings(
    ...
    public static NoiseGeneratorSettings overworld(BootstapContext<?> pContext, boolean pAmplified, boolean pLarge) {
        return new NoiseGeneratorSettings(
            ...
            NoiseRouterData.overworld(pContext.lookup(Registries.DENSITY_FUNCTION), pContext.lookup(Registries.NOISE), pLarge, pAmplified),
    ...
    public static NoiseGeneratorSettings floatingIslands(BootstapContext<?> pContex) {
        return new NoiseGeneratorSettings(
            ...
            Blocks.STONE.defaultBlockState(),
            Blocks.WATER.defaultBlockState(),
            NoiseRouterData.floatingIslands(pContex.lookup(Registries.DENSITY_FUNCTION), pContex.lookup(Registries.NOISE)),
