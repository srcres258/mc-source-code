...
public class NoiseRouterData {
    ...
    public static Holder<? extends DensityFunction> bootstrap(BootstapContext<DensityFunction> pContext) {
        ...
        registerTerrainNoises(
            pContext, holdergetter1, densityfunction3, holder2, holder3, OFFSET_LARGE, FACTOR_LARGE, JAGGEDNESS_LARGE, DEPTH_LARGE, SLOPED_CHEESE_LARGE, false
        );
        registerTerrainNoises(
            pContext,
            holdergetter1,
    ...
    private static DensityFunction registerAndWrap(
        BootstapContext<DensityFunction> pContext, ResourceKey<DensityFunction> pKey, DensityFunction pDensityFunction
    ) {
    ...
    private static DensityFunction noodle(HolderGetter<DensityFunction> pDensityFunctions, HolderGetter<NormalNoise.NoiseParameters> pNoiseParameters) {
        ...
        DensityFunction densityfunction1 = yLimitedInterpolatable(
            densityfunction, DensityFunctions.noise(pNoiseParameters.getOrThrow(Noises.NOODLE), 1.0, 1.0), -60, 320, -1
        );
    ...
    private static DensityFunction spaghetti2D(HolderGetter<DensityFunction> pDensityFunctions, HolderGetter<NormalNoise.NoiseParameters> pNoiseParameters) {
        ...
        DensityFunction densityfunction2 = DensityFunctions.mappedNoise(
            pNoiseParameters.getOrThrow(Noises.SPAGHETTI_2D_ELEVATION), 0.0, (double)Math.floorDiv(-64, 8), 8.0
        );
