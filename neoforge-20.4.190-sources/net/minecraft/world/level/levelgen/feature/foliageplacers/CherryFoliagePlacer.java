...
public class CherryFoliagePlacer extends FoliagePlacer {
    ...
    protected void createFoliage(
        ...
        this.placeLeavesRowWithHangingLeavesBelow(
            pLevel, pBlockSetter, pRandom, pConfig, blockpos, i, -1, flag, this.hangingLeavesChance, this.hangingLeavesExtensionChance
        );
        this.placeLeavesRowWithHangingLeavesBelow(
            pLevel, pBlockSetter, pRandom, pConfig, blockpos, i - 1, -2, flag, this.hangingLeavesChance, this.hangingLeavesExtensionChance
        );
    }
