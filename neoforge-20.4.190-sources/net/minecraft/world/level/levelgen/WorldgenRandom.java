...
public class WorldgenRandom extends LegacyRandomSource {
    ...
    public int next(int pBits) {
        ...
        return randomsource instanceof LegacyRandomSource legacyrandomsource
     ...
     *
     * @param pDecorationSeed The seed computed by {@link #setDecorationSeed(long, int
     *                        , int)}
     * @param pIndex          The cumulative index of the generating feature within
     *                        the biome's list of features.
     * @param pDecorationStep The ordinal of the {@link
     ...
     *
     * @param pBaseSeed This is passed in as the level seed, or in some cases such as
     *                  carvers, as an offset from the level seed unique to each
     *                  carver.
     */
